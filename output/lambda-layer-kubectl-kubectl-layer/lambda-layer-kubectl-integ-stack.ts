...
export interface LambdaLayerKubectlIntegStackProps extends cdk.StackProps {
  /**
...
export class LambdaLayerKubectlIntegStack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: LambdaLayerKubectlIntegStackProps = {}) {
