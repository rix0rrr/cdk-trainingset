...
export interface lambda-layer-kubectl-integ-stackProps extends cdk.StackProps {
  /**
...
export class lambda-layer-kubectl-integ-stack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: lambda-layer-kubectl-integ-stackProps = {}) {
