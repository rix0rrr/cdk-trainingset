...
export class cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderB281C954.nested extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderB281C954.nestedProps) {
    ...
    const isCompleteHandler7073F4da = new lambda.CfnFunction(this, 'IsCompleteHandler7073F4DA', {
      code: {
        s3Bucket: `cdk-hnb659fds-assets-${this.account}-eu-west-1`,
          ...
          },
          {
            ...
            Resource: [
              [
                ...
                this.account,
                ':table/',
                props.referencetocdkdynamodbglobal20191121TableB640876bRef!,
              ].join(''),
              [
                'arn:',
                this.partition,
    ...
    // Outputs
    this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderOnEventHandlerServiceRole3E8625f3Ref = onEventHandlerServiceRole15A26729.ref;
    new cdk.CfnOutput(this, 'CfnOutputcdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderOnEventHandlerServiceRole3E8625F3Ref', {
      key: 'cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderOnEventHandlerServiceRole3E8625F3Ref',
      value: this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderOnEventHandlerServiceRole3E8625f3Ref!.toString(),
    });
    this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderIsCompleteHandlerServiceRole2F936ec4Ref = isCompleteHandlerServiceRole5810Cc58.ref;
    new cdk.CfnOutput(this, 'CfnOutputcdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderIsCompleteHandlerServiceRole2F936EC4Ref', {
      key: 'cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderIsCompleteHandlerServiceRole2F936EC4Ref',
      value: this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderIsCompleteHandlerServiceRole2F936ec4Ref!.toString(),
    });
    this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderframeworkonEventCfdd0ba0Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputcdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderframeworkonEventCFDD0BA0Arn', {
      key: 'cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderframeworkonEventCFDD0BA0Arn',
      value: this.cdkdynamodbglobal20191121awscdkawsdynamodbReplicaProviderframeworkonEventCfdd0ba0Arn!.toString(),
    });
  }
}
