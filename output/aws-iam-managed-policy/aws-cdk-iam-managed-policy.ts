...
export interface AwsCdkIamManagedPolicyProps extends cdk.StackProps {
  /**
...
export class AwsCdkIamManagedPolicy extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkIamManagedPolicyProps = {}) {
