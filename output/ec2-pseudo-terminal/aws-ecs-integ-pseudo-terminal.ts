...
export interface aws-ecs-integ-pseudo-terminalProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-pseudo-terminal extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-pseudo-terminalProps = {}) {
    ...
    if (ecsClusterDefaultAutoScalingGroupLifecycleHookDrainHookTopicAcd2d4a4 == null) { throw new Error(`A combination of conditions caused 'ecsClusterDefaultAutoScalingGroupLifecycleHookDrainHookTopicAcd2d4a4' to be undefined. Fixit.`); }
    const ecsClusterDefaultAutoScalingGroupDrainEcsHookFunctionAllowInvokeawsecsintegpseudoterminalEcsClusterDefaultAutoScalingGroupLifecycleHookDrainHookTopic8C590529a250292c = new lambda.CfnPermission(this, 'EcsClusterDefaultAutoScalingGroupDrainECSHookFunctionAllowInvokeawsecsintegpseudoterminalEcsClusterDefaultAutoScalingGroupLifecycleHookDrainHookTopic8C590529A250292C', {
