...
export interface aws-ecs-integ-l3-vpconlyProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-l3-vpconly extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-l3-vpconlyProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-l3-vpconly/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-l3-vpconly/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-l3-vpconly/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const albFargateServiceLbSecurityGroup5Dc3060e = new ec2.CfnSecurityGroup(this, 'ALBFargateServiceLBSecurityGroup5DC3060E', {
      groupDescription: 'Automatically created Security Group for ELB awsecsintegl3vpconlyALBFargateServiceLBE08492C1',
    ...
    const albFargateServiceSecurityGroup82F7a67e = new ec2.CfnSecurityGroup(this, 'ALBFargateServiceSecurityGroup82F7A67E', {
      groupDescription: 'aws-ecs-integ-l3-vpconly/ALBFargateService/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const albFargateServiceTaskDefF69f17d6 = new ecs.CfnTaskDefinition(this, 'ALBFargateServiceTaskDefF69F17D6', {
      ...
      family: 'awsecsintegl3vpconlyALBFargateServiceTaskDef846555AE',
      memory: '1024',
      networkMode: 'awsvpc',
    ...
    const nlbFargateServiceSecurityGroup9D81388b = new ec2.CfnSecurityGroup(this, 'NLBFargateServiceSecurityGroup9D81388B', {
      groupDescription: 'aws-ecs-integ-l3-vpconly/NLBFargateService/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
          description: 'Allow all outbound traffic by default',
    ...
    const nlbFargateServiceTaskDefB836fa89 = new ecs.CfnTaskDefinition(this, 'NLBFargateServiceTaskDefB836FA89', {
      ...
      family: 'awsecsintegl3vpconlyNLBFargateServiceTaskDef1E6E41A6',
      memory: '1024',
      networkMode: 'awsvpc',
      requiresCompatibilities: [
        'FARGATE',
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-l3-vpconly/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const albFargateServiceLbSecurityGrouptoawsecsintegl3vpconlyAlbFargateServiceSecurityGroup3700A42180d1ab9dbc = new ec2.CfnSecurityGroupEgress(this, 'ALBFargateServiceLBSecurityGrouptoawsecsintegl3vpconlyALBFargateServiceSecurityGroup3700A42180D1AB9DBC', {
    ...
    if (albFargateServiceSecurityGroup82F7a67e == null) { throw new Error(`A combination of conditions caused 'albFargateServiceSecurityGroup82F7a67e' to be undefined. Fixit.`); }
    if (albFargateServiceTaskDefTaskRole11408723 == null) { throw new Error(`A combination of conditions caused 'albFargateServiceTaskDefTaskRole11408723' to be undefined. Fixit.`); }
    const albFargateServiceSecurityGroupfromawsecsintegl3vpconlyAlbFargateServiceLbSecurityGroup96E9bbbd8073fb670d = new ec2.CfnSecurityGroupIngress(this, 'ALBFargateServiceSecurityGroupfromawsecsintegl3vpconlyALBFargateServiceLBSecurityGroup96E9BBBD8073FB670D', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 80,
    ...
    albFargateServiceSecurityGroupfromawsecsintegl3vpconlyAlbFargateServiceLbSecurityGroup96E9bbbd8073fb670d.addDependency(albFargateServiceTaskDefTaskRole11408723);
