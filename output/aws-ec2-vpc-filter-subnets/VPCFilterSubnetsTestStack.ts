...
export interface VpcfiltersubnetsteststackProps extends cdk.StackProps {
  /**
...
export class Vpcfiltersubnetsteststack extends cdk.Stack {
  public readonly privateSubnet01;
  public readonly publicSubnet01;

  public constructor(scope: cdk.App, id: string, props: VpcfiltersubnetsteststackProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'VPCFilterSubnetsTestStack/Vpc',
        },
      ],
    });
    ...
    // Outputs
    this.privateSubnet01 = vpcPrivateSubnet1Subnet536B997a.ref;
    new cdk.CfnOutput(this, 'CfnOutputPrivateSubnet01', {
      key: 'PrivateSubnet01',
      value: this.privateSubnet01!.toString(),
    });
    this.publicSubnet01 = vpcPublicSubnet1Subnet5C2d37c4.ref;
    new cdk.CfnOutput(this, 'CfnOutputPublicSubnet01', {
      key: 'PublicSubnet01',
      value: this.publicSubnet01!.toString(),
    });
  }
}
