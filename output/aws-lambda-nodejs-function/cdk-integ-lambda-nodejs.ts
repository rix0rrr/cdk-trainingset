...
export interface CdkIntegLambdaNodejsProps extends cdk.StackProps {
  /**
...
export class CdkIntegLambdaNodejs extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CdkIntegLambdaNodejsProps = {}) {
