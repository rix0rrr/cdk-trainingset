...
export interface AwsCdkElbv2IntegProps extends cdk.StackProps {
  /**
...
export class AwsCdkElbv2Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkElbv2IntegProps = {}) {
    ...
    if (vpcigwb7e252d3 == null) { throw new Error(`A combination of conditions caused 'vpcigwb7e252d3' to be undefined. Fixit.`); }
    if (vpcPublicSubnet1RouteTableFee4b781 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet1RouteTableFee4b781' to be undefined. Fixit.`); }
    const vpcPublicSubnet1IPv6DefaultFd18367e = new ec2.CfnRoute(this, 'VPCPublicSubnet1IPv6DefaultFD18367E', {
      routeTableId: vpcPublicSubnet1RouteTableFee4b781.ref,
    ...
    const vpcPublicSubnet1SubnetB4246d30 = new ec2.CfnSubnet(this, 'VPCPublicSubnet1SubnetB4246D30', {
      ...
      ipv6CidrBlock: cdk.Fn.select(0, cdk.Fn.cidr(cdk.Fn.select(0, vpcb9e5f0b4.attrIpv6CidrBlocks), 2, String('64'))),
    ...
    vpcPublicSubnet1SubnetB4246d30.addDependency(iPv6Block);
    ...
    if (vpcigwb7e252d3 == null) { throw new Error(`A combination of conditions caused 'vpcigwb7e252d3' to be undefined. Fixit.`); }
    if (vpcPublicSubnet2RouteTable6F1a15f1 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet2RouteTable6F1a15f1' to be undefined. Fixit.`); }
    const vpcPublicSubnet2IPv6DefaultDd0476c2 = new ec2.CfnRoute(this, 'VPCPublicSubnet2IPv6DefaultDD0476C2', {
      routeTableId: vpcPublicSubnet2RouteTable6F1a15f1.ref,
      destinationIpv6CidrBlock: '::/0',
      gatewayId: vpcigwb7e252d3.ref,
    });
    ...
    const vpcPublicSubnet2Subnet74179F39 = new ec2.CfnSubnet(this, 'VPCPublicSubnet2Subnet74179F39', {
      ...
      ipv6CidrBlock: cdk.Fn.select(1, cdk.Fn.cidr(cdk.Fn.select(0, vpcb9e5f0b4.attrIpv6CidrBlocks), 2, String('64'))),
      mapPublicIpOnLaunch: true,
      tags: [
        {
          key: 'aws-cdk:subnet-name',
    ...
    vpcPublicSubnet2Subnet74179F39.addDependency(iPv6Block);
    ...
    if (vpcPublicSubnet1DefaultRoute91Cef279 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet1DefaultRoute91Cef279' to be undefined. Fixit.`); }
    if (vpcPublicSubnet1Eip6ad938e8 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet1Eip6ad938e8' to be undefined. Fixit.`); }
    if (vpcPublicSubnet1IPv6DefaultFd18367e == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet1IPv6DefaultFd18367e' to be undefined. Fixit.`); }
    ...
    if (vpcPublicSubnet2DefaultRouteB7481bba == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet2DefaultRouteB7481bba' to be undefined. Fixit.`); }
    if (vpcPublicSubnet2Eip4947bc00 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet2Eip4947bc00' to be undefined. Fixit.`); }
    if (vpcPublicSubnet2IPv6DefaultDd0476c2 == null) { throw new Error(`A combination of conditions caused 'vpcPublicSubnet2IPv6DefaultDd0476c2' to be undefined. Fixit.`); }
    ...
    lbListenerConditionalTargetGroupA75cccd9.addDependency(vpcPublicSubnet1IPv6DefaultFd18367e);
    ...
    lbListenerConditionalTargetGroupA75cccd9.addDependency(vpcPublicSubnet2IPv6DefaultDd0476c2);
    ...
    lbListenerTargetGroupF04fcf6d.addDependency(vpcPublicSubnet1IPv6DefaultFd18367e);
    ...
    lbListenerTargetGroupF04fcf6d.addDependency(vpcPublicSubnet2IPv6DefaultDd0476c2);
