...
export class AwsCdkElbv2Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkElbv2IntegProps = {}) {
    ...
    const tgb29b09e7 = new elasticloadbalancingv2.CfnTargetGroup(this, 'TGB29B09E7', {
      port: 443,
      protocol: 'TCP',
    ...
    tgb29b09e7.addDependency(vpcigwb7e252d3);
    ...
    if (tgb29b09e7 == null) { throw new Error(`A combination of conditions caused 'tgb29b09e7' to be undefined. Fixit.`); }
    const lBlistenerE5d117cc = new elasticloadbalancingv2.CfnListener(this, 'LBlistenerE5D117CC', {
      defaultActions: [
        {
          targetGroupArn: tgb29b09e7.ref,
          type: 'forward',
        },
      ],
