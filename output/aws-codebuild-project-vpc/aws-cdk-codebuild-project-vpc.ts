  ...
  public constructor(scope: cdk.App, id: string, props: AwsCdkCodebuildProjectVpcProps = {}) {
    ...
    const myVpcafb07a31 = new ec2.CfnVPC(this, 'MyVPCAFB07A31', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codebuild-project-vpc/MyVPC',
        },
      ],
    });
    ...
    const myVpcPublicSubnet1Eip5eb6147d = new ec2.CfnEIP(this, 'MyVPCPublicSubnet1EIP5EB6147D', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codebuild-project-vpc/MyVPC/PublicSubnet1',
        },
      ],
    });
    ...
    const myVpcPrivateSubnet1RouteTable133Bd901 = new ec2.CfnRouteTable(this, 'MyVPCPrivateSubnet1RouteTable133BD901', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codebuild-project-vpc/MyVPC/PrivateSubnet1',
        },
      ],
    });
