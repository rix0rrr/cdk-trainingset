...
export class aws-ecs-integ-ecs extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-ecsProps = {}) {
    ...
    if (vpc8378Eb38 == null) { throw new Error(`A combination of conditions caused 'vpc8378Eb38' to be undefined. Fixit.`); }
    const frontendServiceSecurityGroup85470Dec = new ec2.CfnSecurityGroup(this, 'FrontendServiceSecurityGroup85470DEC', {
    ...
    frontendServiceSecurityGroup85470Dec.addDependency(taskDefTaskRole1Edb4a67);
    ...
    frontendServiceCloudmapService6Fe76c06.addDependency(taskDefTaskRole1Edb4a67);
    ...
    if (frontendServiceSecurityGroup85470Dec == null) { throw new Error(`A combination of conditions caused 'frontendServiceSecurityGroup85470Dec' to be undefined. Fixit.`); }
    ...
    const frontendServiceBc94ba93 = new ecs.CfnService(this, 'FrontendServiceBC94BA93', {
      ...
      networkConfiguration: {
        awsvpcConfiguration: {
          ...
          securityGroups: [
            frontendServiceSecurityGroup85470Dec.attrGroupId,
          ],
          subnets: [
            vpcPrivateSubnet1Subnet536B997a.ref,
            vpcPrivateSubnet2Subnet3788Aaa1.ref,
    ...
    frontendServiceBc94ba93.addDependency(taskDefTaskRole1Edb4a67);
