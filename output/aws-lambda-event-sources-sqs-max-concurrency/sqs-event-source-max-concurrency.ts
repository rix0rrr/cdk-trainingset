...
export interface SqsEventSourceMaxConcurrencyProps extends cdk.StackProps {
  /**
...
export class SqsEventSourceMaxConcurrency extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: SqsEventSourceMaxConcurrencyProps = {}) {
