...
export interface sqs-event-source-max-concurrencyProps extends cdk.StackProps {
  /**
...
export class sqs-event-source-max-concurrency extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: sqs-event-source-max-concurrencyProps = {}) {
    ...
    if (q63c6e3ab == null) { throw new Error(`A combination of conditions caused 'q63c6e3ab' to be undefined. Fixit.`); }
    const fSqsEventSourcesqseventsourcemaxconcurrencyQ1268c091130bf341 = new lambda.CfnEventSourceMapping(this, 'FSqsEventSourcesqseventsourcemaxconcurrencyQ1268C091130BF341', {
      batchSize: 5,
