...
export interface AwsCdkEmrCreateClusterWithSpotInstanceFleetProps extends cdk.StackProps {
  /**
...
export class AwsCdkEmrCreateClusterWithSpotInstanceFleet extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkEmrCreateClusterWithSpotInstanceFleetProps = {}) {
