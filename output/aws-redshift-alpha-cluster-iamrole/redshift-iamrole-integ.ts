...
export class RedshiftIamroleInteg extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: RedshiftIamroleIntegProps = {}) {
    ...
    const roleA3119c8fe = new iam.CfnRole(this, 'RoleA3119C8FE', {
    ...
    const roleB318292c8 = new iam.CfnRole(this, 'RoleB318292C8', {
      assumeRolePolicyDocument: {
        Statement: [
          {
            Action: 'sts:AssumeRole',
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'redshift-iamrole-integ/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'redshift-iamrole-integ/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip4947bc00 = new ec2.CfnEIP(this, 'VPCPublicSubnet2EIP4947BC00', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'redshift-iamrole-integ/VPC/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableBe8a6027 = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet1RouteTableBE8A6027', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'redshift-iamrole-integ/VPC/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'redshift-iamrole-integ/VPC/PrivateSubnet2',
        },
      ],
    });
    ...
    if (roleA3119c8fe == null) { throw new Error(`A combination of conditions caused 'roleA3119c8fe' to be undefined. Fixit.`); }
    if (roleB318292c8 == null) { throw new Error(`A combination of conditions caused 'roleB318292c8' to be undefined. Fixit.`); }
    const clusterEb0386a7 = new redshift.CfnCluster(this, 'ClusterEB0386A7', {
      ...
      encrypted: true,
      iamRoles: [
        roleB318292c8.attrArn,
        roleA3119c8fe.attrArn,
      ],
      numberOfNodes: 2,
