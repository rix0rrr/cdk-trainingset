...
export interface aws-cdk-s3-minimum-tls-versionProps extends cdk.StackProps {
  /**
...
export class aws-cdk-s3-minimum-tls-version extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-s3-minimum-tls-versionProps = {}) {
