...
export interface AwsStepfunctionsTasksAthenaGetQueryResultsIntegProps extends cdk.StackProps {
  /**
...
export class AwsStepfunctionsTasksAthenaGetQueryResultsInteg extends cdk.Stack {
  public readonly stateMachineArn;

  public constructor(scope: cdk.App, id: string, props: AwsStepfunctionsTasksAthenaGetQueryResultsIntegProps = {}) {
