...
export interface awscdkeksclusterawscdkawseksClusterResourceProvider0DD9B7A4.nestedProps extends cdk.StackProps {
}

export class awscdkeksclusterawscdkawseksClusterResourceProvider0DD9B7A4.nested extends cdk.Stack {
  public readonly awscdkeksclusterawscdkawseksClusterResourceProviderOnEventHandlerServiceRole9C5eb73bArn;
  public readonly awscdkeksclusterawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole95B1cfc8Arn;
  public readonly awscdkeksclusterawscdkawseksClusterResourceProviderframeworkonEventE7ab77f7Arn;

  public constructor(scope: cdk.App, id: string, props: awscdkeksclusterawscdkawseksClusterResourceProvider0DD9B7A4.nestedProps = {}) {
    ...
    const providerframeworkisComplete26D7b0cb = new lambda.CfnFunction(this, 'ProviderframeworkisComplete26D7B0CB', {
      ...
      description: 'AWS CDK resource provider framework - isComplete (aws-cdk-eks-cluster/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
    ...
    const providerframeworkonTimeout0B47ca38 = new lambda.CfnFunction(this, 'ProviderframeworkonTimeout0B47CA38', {
      ...
      description: 'AWS CDK resource provider framework - onTimeout (aws-cdk-eks-cluster/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    const providerframeworkonEvent83C1d0a7 = new lambda.CfnFunction(this, 'ProviderframeworkonEvent83C1D0A7', {
      ...
      description: 'AWS CDK resource provider framework - onEvent (aws-cdk-eks-cluster/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    // Outputs
    this.awscdkeksclusterawscdkawseksClusterResourceProviderOnEventHandlerServiceRole9C5eb73bArn = onEventHandlerServiceRole15A26729.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusterawscdkawseksClusterResourceProviderOnEventHandlerServiceRole9C5EB73BArn', {
      key: 'awscdkeksclusterawscdkawseksClusterResourceProviderOnEventHandlerServiceRole9C5EB73BArn',
      value: this.awscdkeksclusterawscdkawseksClusterResourceProviderOnEventHandlerServiceRole9C5eb73bArn!.toString(),
    });
    this.awscdkeksclusterawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole95B1cfc8Arn = isCompleteHandlerServiceRole5810Cc58.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusterawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole95B1CFC8Arn', {
      key: 'awscdkeksclusterawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole95B1CFC8Arn',
      value: this.awscdkeksclusterawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole95B1cfc8Arn!.toString(),
    });
    this.awscdkeksclusterawscdkawseksClusterResourceProviderframeworkonEventE7ab77f7Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusterawscdkawseksClusterResourceProviderframeworkonEventE7AB77F7Arn', {
      key: 'awscdkeksclusterawscdkawseksClusterResourceProviderframeworkonEventE7AB77F7Arn',
      value: this.awscdkeksclusterawscdkawseksClusterResourceProviderframeworkonEventE7ab77f7Arn!.toString(),
    });
  }
}
