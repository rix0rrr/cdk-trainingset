...
export class integ-nlb-integration extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: integ-nlb-integrationProps = {}) {
    ...
    if (lblistenertargetGroupC7489d1e == null) { throw new Error(`A combination of conditions caused 'lblistenertargetGroupC7489d1e' to be undefined. Fixit.`); }
    const lblistener657Addec = new elasticloadbalancingv2.CfnListener(this, 'lblistener657ADDEC', {
      defaultActions: [
        {
          targetGroupArn: lblistenertargetGroupC7489d1e.ref,
          type: 'forward',
        },
      ],
