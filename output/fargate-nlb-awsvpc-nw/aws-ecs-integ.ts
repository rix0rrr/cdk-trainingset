...
export class AwsEcsInteg extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegProps = {}) {
    ...
    const lbPublicListenerEcsGroupD6a32205 = new elasticloadbalancingv2.CfnTargetGroup(this, 'LBPublicListenerECSGroupD6A32205', {
      port: 80,
      protocol: 'TCP',
      targetType: 'ip',
    ...
    if (lbPublicListenerEcsGroupD6a32205 == null) { throw new Error(`A combination of conditions caused 'lbPublicListenerEcsGroupD6a32205' to be undefined. Fixit.`); }
    const lbPublicListener6E1f3d94 = new elasticloadbalancingv2.CfnListener(this, 'LBPublicListener6E1F3D94', {
      defaultActions: [
        {
          targetGroupArn: lbPublicListenerEcsGroupD6a32205.ref,
          type: 'forward',
        },
      ],
    ...
    serviceD69d759b.addDependency(lbPublicListenerEcsGroupD6a32205);
