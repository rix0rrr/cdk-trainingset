...
export interface aws-cdk-lambda-runtime-managementProps extends cdk.StackProps {
  /**
...
export class aws-cdk-lambda-runtime-management extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-lambda-runtime-managementProps = {}) {
