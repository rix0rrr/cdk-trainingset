...
export interface aws-cdk-asset-testProps extends cdk.StackProps {
  /**
...
export class aws-cdk-asset-test extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-asset-testProps = {}) {
