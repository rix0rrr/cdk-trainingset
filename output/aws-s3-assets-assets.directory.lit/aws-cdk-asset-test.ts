...
export interface AwsCdkAssetTestProps extends cdk.StackProps {
  /**
...
export class AwsCdkAssetTest extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkAssetTestProps = {}) {
