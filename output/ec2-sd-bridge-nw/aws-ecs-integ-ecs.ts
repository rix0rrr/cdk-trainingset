...
export class AwsEcsIntegEcs extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegEcsProps = {}) {
    ...
    const frontendTdTaskRole638562A0 = new iam.CfnRole(this, 'frontendTDTaskRole638562A0', {
      assumeRolePolicyDocument: {
        Statement: [
          {
            Action: 'sts:AssumeRole',
    ...
    if (frontendTdTaskRole638562A0 == null) { throw new Error(`A combination of conditions caused 'frontendTdTaskRole638562A0' to be undefined. Fixit.`); }
    const frontendTdb289c8fa = new ecs.CfnTaskDefinition(this, 'frontendTDB289C8FA', {
      ...
      taskRoleArn: frontendTdTaskRole638562A0.attrArn,
    });
    ...
    if (frontendTdTaskRole638562A0 == null) { throw new Error(`A combination of conditions caused 'frontendTdTaskRole638562A0' to be undefined. Fixit.`); }
    const frontendServiceCloudmapService6Fe76c06 = new servicediscovery.CfnService(this, 'FrontendServiceCloudmapService6FE76C06', {
      dnsConfig: {
        dnsRecords: [
          {
            ttl: 60,
        ...
        namespaceId: ecsClusterDefaultServiceDiscoveryNamespaceB0971b2f.attrId,
    ...
    frontendServiceCloudmapService6Fe76c06.addDependency(frontendTdTaskRole638562A0);
    ...
    if (ecsCluster97242B84 == null) { throw new Error(`A combination of conditions caused 'ecsCluster97242B84' to be undefined. Fixit.`); }
    if (frontendServiceCloudmapService6Fe76c06 == null) { throw new Error(`A combination of conditions caused 'frontendServiceCloudmapService6Fe76c06' to be undefined. Fixit.`); }
    if (frontendTdb289c8fa == null) { throw new Error(`A combination of conditions caused 'frontendTdb289c8fa' to be undefined. Fixit.`); }
    if (frontendTdTaskRole638562A0 == null) { throw new Error(`A combination of conditions caused 'frontendTdTaskRole638562A0' to be undefined. Fixit.`); }
    const frontendServiceBc94ba93 = new ecs.CfnService(this, 'FrontendServiceBC94BA93', {
      ...
      serviceRegistries: [
        {
          ...
          containerPort: 80,
          registryArn: frontendServiceCloudmapService6Fe76c06.attrArn,
        },
      ],
      taskDefinition: frontendTdb289c8fa.ref,
    });
    frontendServiceBc94ba93.addDependency(frontendTdTaskRole638562A0);
