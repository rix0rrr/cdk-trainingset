...
export interface aws-cdk-report-groupProps extends cdk.StackProps {
  /**
...
export class aws-cdk-report-group extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-report-groupProps = {}) {
