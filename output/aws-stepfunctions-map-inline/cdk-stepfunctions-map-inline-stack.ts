...
export interface CdkStepfunctionsMapInlineStackProps extends cdk.StackProps {
  /**
...
export class CdkStepfunctionsMapInlineStack extends cdk.Stack {
  public readonly stateMachineArn;

  public constructor(scope: cdk.App, id: string, props: CdkStepfunctionsMapInlineStackProps = {}) {
