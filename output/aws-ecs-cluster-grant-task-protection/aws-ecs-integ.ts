...
export class AwsEcsInteg extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegProps = {}) {
    ...
    const taskRole30Fc0fbb = new iam.CfnRole(this, 'TaskRole30FC0FBB', {
    ...
    if (taskRole30Fc0fbb == null) { throw new Error(`A combination of conditions caused 'taskRole30Fc0fbb' to be undefined. Fixit.`); }
    const taskRoleDefaultPolicy07Fc53de = new iam.CfnPolicy(this, 'TaskRoleDefaultPolicy07FC53DE', {
      policyDocument: {
        Statement: [
          {
