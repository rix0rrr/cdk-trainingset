...
export interface CdkIntegLambdaNodejsLatestProps extends cdk.StackProps {
  /**
...
export class CdkIntegLambdaNodejsLatest extends cdk.Stack {
  public readonly exportsOutputReflatestFe0d80b6c9b17e6b;

  public constructor(scope: cdk.App, id: string, props: CdkIntegLambdaNodejsLatestProps = {}) {
