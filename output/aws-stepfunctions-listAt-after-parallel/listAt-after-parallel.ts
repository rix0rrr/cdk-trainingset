...
export interface listAt-after-parallelProps extends cdk.StackProps {
  /**
...
export class listAt-after-parallel extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: listAt-after-parallelProps = {}) {
