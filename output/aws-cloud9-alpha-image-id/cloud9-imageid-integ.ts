...
export interface Cloud9ImageidIntegProps extends cdk.StackProps {
  /**
...
export class Cloud9ImageidInteg extends cdk.Stack {
  public readonly url;
  public readonly arn;

  public constructor(scope: cdk.App, id: string, props: Cloud9ImageidIntegProps = {}) {
