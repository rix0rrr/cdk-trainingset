...
export interface cloud9-imageid-integProps extends cdk.StackProps {
  /**
...
export class cloud9-imageid-integ extends cdk.Stack {
  public readonly url;
  public readonly arn;

  public constructor(scope: cdk.App, id: string, props: cloud9-imageid-integProps = {}) {
