...
export interface aws-cdk-bucket-inventoryProps extends cdk.StackProps {
  /**
...
export class aws-cdk-bucket-inventory extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-bucket-inventoryProps = {}) {
