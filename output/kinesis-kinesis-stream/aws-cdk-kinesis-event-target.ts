...
export interface AwsCdkKinesisEventTargetProps extends cdk.StackProps {
  /**
...
export class AwsCdkKinesisEventTarget extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkKinesisEventTargetProps = {}) {
