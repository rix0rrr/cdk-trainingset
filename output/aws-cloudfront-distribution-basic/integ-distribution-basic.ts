...
export interface IntegDistributionBasicProps extends cdk.StackProps {
  /**
...
export class IntegDistributionBasic extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: IntegDistributionBasicProps = {}) {
