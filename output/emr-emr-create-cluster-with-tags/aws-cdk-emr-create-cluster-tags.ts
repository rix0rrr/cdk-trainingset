...
export interface AwsCdkEmrCreateClusterTagsProps extends cdk.StackProps {
  /**
...
export class AwsCdkEmrCreateClusterTags extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkEmrCreateClusterTagsProps = {}) {
