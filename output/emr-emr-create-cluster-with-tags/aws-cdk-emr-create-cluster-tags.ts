...
export interface aws-cdk-emr-create-cluster-tagsProps extends cdk.StackProps {
  /**
...
export class aws-cdk-emr-create-cluster-tags extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-emr-create-cluster-tagsProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        ...
        {
          key: 'Name',
          value: 'aws-cdk-emr-create-cluster-tags/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        ...
        {
          key: 'Name',
          value: 'aws-cdk-emr-create-cluster-tags/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        ...
        {
          key: 'Name',
          value: 'aws-cdk-emr-create-cluster-tags/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      tags: [
        ...
        {
          key: 'Name',
          value: 'aws-cdk-emr-create-cluster-tags/Vpc/PrivateSubnet1',
        },
      ],
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      tags: [
        ...
        {
          key: 'Name',
          value: 'aws-cdk-emr-create-cluster-tags/Vpc/PrivateSubnet2',
        },
      ],
      vpcId: vpc8378Eb38.ref,
    });
    ...
    const sm934e715a = new stepfunctions.CfnStateMachine(this, 'SM934E715A', {
      definitionString: [
        ...
        emrCreateClusterServiceRole5251910D.ref,
        '\",\"ReleaseLabel\":\"emr-6.15.0\",\"Tags\":[{\"Key\":\"Key\",\"Value\":\"Value\"},{\"Key\":\"for-use-with-amazon-emr-managed-policies\",\"Value\":\"true\"}],\"VisibleToAllUsers\":true}}}}',
      ].join(''),
