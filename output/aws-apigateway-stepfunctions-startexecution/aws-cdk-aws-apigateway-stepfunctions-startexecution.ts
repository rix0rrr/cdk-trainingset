...
export interface aws-cdk-aws-apigateway-stepfunctions-startexecutionProps extends cdk.StackProps {
  /**
...
export class aws-cdk-aws-apigateway-stepfunctions-startexecution extends cdk.Stack {
  public readonly myrestapiEndpoint0De8a5de;

  public constructor(scope: cdk.App, id: string, props: aws-cdk-aws-apigateway-stepfunctions-startexecutionProps = {}) {
    ...
    const myrestapiPostStartSyncExecutionRole7Afbe835 = new iam.CfnRole(this, 'myrestapiPOSTStartSyncExecutionRole7AFBE835', {
      assumeRolePolicyDocument: {
        Statement: [
          {
            Action: 'sts:AssumeRole',
    ...
    if (stateMachine2E01a3a5 == null) { throw new Error(`A combination of conditions caused 'stateMachine2E01a3a5' to be undefined. Fixit.`); }
    if (myrestapiBac2bf45 == null) { throw new Error(`A combination of conditions caused 'myrestapiBac2bf45' to be undefined. Fixit.`); }
    if (myrestapiPostStartSyncExecutionRole7Afbe835 == null) { throw new Error(`A combination of conditions caused 'myrestapiPostStartSyncExecutionRole7Afbe835' to be undefined. Fixit.`); }
    const myrestapiPost155a9625 = new apigateway.CfnMethod(this, 'myrestapiPOST155A9625', {
      authorizationType: 'NONE',
      httpMethod: 'POST',
      integration: {
        credentials: myrestapiPostStartSyncExecutionRole7Afbe835.attrArn,
        integrationHttpMethod: 'POST',
        integrationResponses: [
          {
            responseParameters: {
    ...
    if (stateMachine2E01a3a5 == null) { throw new Error(`A combination of conditions caused 'stateMachine2E01a3a5' to be undefined. Fixit.`); }
    if (myrestapiPostStartSyncExecutionRole7Afbe835 == null) { throw new Error(`A combination of conditions caused 'myrestapiPostStartSyncExecutionRole7Afbe835' to be undefined. Fixit.`); }
    const myrestapiPostStartSyncExecutionRoleDefaultPolicy7D411ae9 = new iam.CfnPolicy(this, 'myrestapiPOSTStartSyncExecutionRoleDefaultPolicy7D411AE9', {
      policyDocument: {
        Statement: [
          {
            Action: 'states:StartSyncExecution',
      ...
      roles: [
        myrestapiPostStartSyncExecutionRole7Afbe835.ref,
      ],
    });
    ...
    if (myrestapiPost155a9625 == null) { throw new Error(`A combination of conditions caused 'myrestapiPost155a9625' to be undefined. Fixit.`); }
    const myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7 = new apigateway.CfnDeployment(this, 'myrestapiDeployment010A9D4F8d8391dd5e41be487121f43257df00d7', {
      description: 'Automatically created by the RestApi construct',
      restApiId: myrestapiBac2bf45.ref,
    });
    myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7.addDependency(myrestapiGet3a49a218);
    myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7.addDependency(myrestapiPost155a9625);

    if (myrestapiBac2bf45 == null) { throw new Error(`A combination of conditions caused 'myrestapiBac2bf45' to be undefined. Fixit.`); }
    if (myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7 == null) { throw new Error(`A combination of conditions caused 'myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7' to be undefined. Fixit.`); }
    const myrestapiDeploymentStageprod3140E1be = new apigateway.CfnStage(this, 'myrestapiDeploymentStageprod3140E1BE', {
      deploymentId: myrestapiDeployment010A9d4f8d8391dd5e41be487121f43257df00d7.ref,
      restApiId: myrestapiBac2bf45.ref,
      stageName: 'prod',
    });
