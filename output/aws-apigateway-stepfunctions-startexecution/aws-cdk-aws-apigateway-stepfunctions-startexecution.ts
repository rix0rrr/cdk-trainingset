...
export interface AwsCdkAwsApigatewayStepfunctionsStartexecutionProps extends cdk.StackProps {
  /**
...
export class AwsCdkAwsApigatewayStepfunctionsStartexecution extends cdk.Stack {
  public readonly myrestapiEndpoint0De8a5de;

  public constructor(scope: cdk.App, id: string, props: AwsCdkAwsApigatewayStepfunctionsStartexecutionProps = {}) {
