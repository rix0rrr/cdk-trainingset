...
export interface integ-kinesis-streamProps extends cdk.StackProps {
  /**
...
export class integ-kinesis-stream extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: integ-kinesis-streamProps = {}) {
