...
export interface cdk-integ-elasticsearch-vpcProps extends cdk.StackProps {
  /**
...
export class cdk-integ-elasticsearch-vpc extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: cdk-integ-elasticsearch-vpcProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cdk-integ-elasticsearch-vpc/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cdk-integ-elasticsearch-vpc/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cdk-integ-elasticsearch-vpc/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cdk-integ-elasticsearch-vpc/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cdk-integ-elasticsearch-vpc/Vpc/PrivateSubnet2',
        },
      ],
    });
