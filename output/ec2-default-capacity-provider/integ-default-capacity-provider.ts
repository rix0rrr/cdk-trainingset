...
export interface integ-default-capacity-providerProps extends cdk.StackProps {
  /**
...
export class integ-default-capacity-provider extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: integ-default-capacity-providerProps = {}) {
    ...
    if (asgLifecycleHookDrainHookTopicA8ad4acb == null) { throw new Error(`A combination of conditions caused 'asgLifecycleHookDrainHookTopicA8ad4acb' to be undefined. Fixit.`); }
    const asgDrainEcsHookFunctionAllowInvokeintegdefaultcapacityproviderAsgLifecycleHookDrainHookTopicB8cf8925702e570f = new lambda.CfnPermission(this, 'ASGDrainECSHookFunctionAllowInvokeintegdefaultcapacityproviderASGLifecycleHookDrainHookTopicB8CF8925702E570F', {
