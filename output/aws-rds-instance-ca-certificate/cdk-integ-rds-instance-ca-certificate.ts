...
export interface CdkIntegRdsInstanceCaCertificateProps extends cdk.StackProps {
  /**
...
export class CdkIntegRdsInstanceCaCertificate extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CdkIntegRdsInstanceCaCertificateProps = {}) {
