...
export interface cdk-integ-rds-instance-ca-certificateProps extends cdk.StackProps {
  /**
...
export class cdk-integ-rds-instance-ca-certificate extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: cdk-integ-rds-instance-ca-certificateProps = {}) {
