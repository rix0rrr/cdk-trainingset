...
export interface aws-cdk-aws-apigatewayv2-http-stageProps extends cdk.StackProps {
  /**
...
export class aws-cdk-aws-apigatewayv2-http-stage extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-aws-apigatewayv2-http-stageProps = {}) {
