...
export interface integ-iam-imported-role-2Props extends cdk.StackProps {
  /**
...
export class integ-iam-imported-role-2 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: integ-iam-imported-role-2Props = {}) {
