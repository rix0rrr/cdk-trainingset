...
export interface IoteventsTimerActionsTestStackProps extends cdk.StackProps {
  /**
...
export class IoteventsTimerActionsTestStack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: IoteventsTimerActionsTestStackProps = {}) {
