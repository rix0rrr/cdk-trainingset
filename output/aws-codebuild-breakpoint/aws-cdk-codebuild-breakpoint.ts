...
export interface AwsCdkCodebuildBreakpointProps extends cdk.StackProps {
  /**
...
export class AwsCdkCodebuildBreakpoint extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkCodebuildBreakpointProps = {}) {
