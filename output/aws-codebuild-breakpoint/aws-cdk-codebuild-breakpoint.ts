...
export interface aws-cdk-codebuild-breakpointProps extends cdk.StackProps {
  /**
...
export class aws-cdk-codebuild-breakpoint extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-codebuild-breakpointProps = {}) {
