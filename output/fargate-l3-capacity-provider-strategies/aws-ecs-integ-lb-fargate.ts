...
export interface aws-ecs-integ-lb-fargateProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-lb-fargate extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-lb-fargateProps = {}) {
    ...
    const fargateClusterFaf97480 = new ecs.CfnClusterCapacityProviderAssociations(this, 'FargateClusterFAF97480', {
      capacityProviders: [
        'FARGATE',
        'FARGATE_SPOT',
      ],
