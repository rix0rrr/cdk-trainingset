...
export interface CodebuildProjectLinuxArmLambdaProps extends cdk.StackProps {
  /**
...
export class CodebuildProjectLinuxArmLambda extends cdk.Stack {
  public readonly exportsOutputRefMyProject39F7b0ae1ce3ca42;

  public constructor(scope: cdk.App, id: string, props: CodebuildProjectLinuxArmLambdaProps = {}) {
