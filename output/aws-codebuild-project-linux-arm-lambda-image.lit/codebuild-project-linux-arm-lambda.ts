...
export interface codebuild-project-linux-arm-lambdaProps extends cdk.StackProps {
  /**
...
export class codebuild-project-linux-arm-lambda extends cdk.Stack {
  public readonly exportsOutputRefMyProject39F7b0ae1ce3ca42;

  public constructor(scope: cdk.App, id: string, props: codebuild-project-linux-arm-lambdaProps = {}) {
    ...
    new cdk.CfnOutput(this, 'CfnOutputExportsOutputRefMyProject39F7B0AE1CE3CA42', {
      ...
      exportName: 'codebuild-project-linux-arm-lambda:ExportsOutputRefMyProject39F7B0AE1CE3CA42',
