...
export interface aws-cdk-neptune-serverless-integProps extends cdk.StackProps {
  /**
...
export class aws-cdk-neptune-serverless-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-neptune-serverless-integProps = {}) {
