...
export interface aws-cdk-layer-version-1Props extends cdk.StackProps {
  /**
...
export class aws-cdk-layer-version-1 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-layer-version-1Props = {}) {
