...
export interface IntegUserPoolIdentityProviderSamlStackProps extends cdk.StackProps {
  /**
...
export class IntegUserPoolIdentityProviderSamlStack extends cdk.Stack {
  public readonly signInLink;

  public constructor(scope: cdk.App, id: string, props: IntegUserPoolIdentityProviderSamlStackProps = {}) {
