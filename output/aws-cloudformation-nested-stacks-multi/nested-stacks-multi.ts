...
export interface nested-stacks-multiProps extends cdk.StackProps {
  /**
...
export class nested-stacks-multi extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: nested-stacks-multiProps = {}) {
