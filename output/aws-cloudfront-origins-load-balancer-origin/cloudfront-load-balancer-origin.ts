  ...
  public constructor(scope: cdk.App, id: string, props: cloudfront-load-balancer-originProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cloudfront-load-balancer-origin/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cloudfront-load-balancer-origin/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cloudfront-load-balancer-origin/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const lbSecurityGroup8A41ea2b = new ec2.CfnSecurityGroup(this, 'LBSecurityGroup8A41EA2B', {
      groupDescription: 'Automatically created Security Group for ELB cloudfrontloadbalanceroriginLB8CFBA9DF',
      securityGroupEgress: [
        {
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cloudfront-load-balancer-origin/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'cloudfront-load-balancer-origin/Vpc/PrivateSubnet2',
        },
      ],
    });
        ...
        origins: [
          {
            ...
            domainName: lb8a12904c.attrDnsName,
            id: 'cloudfrontloadbalanceroriginDistributionOrigin1BCC75186',
          },
        ],
      },
    });
