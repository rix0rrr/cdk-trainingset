...
export interface aws-ecs-integProps extends cdk.StackProps {
   ...
   */
  readonly ssmParameterValueawsserviceawsforfluentbit210C96584b6f00a464ead1953aff4b05118Parameter?: string;
  /**
...
export class aws-ecs-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integProps = {}) {
    ...
    props = {
      ...
      ssmParameterValueawsserviceawsforfluentbit210C96584b6f00a464ead1953aff4b05118Parameter: new cdk.CfnParameter(this, 'SsmParameterValueawsserviceawsforfluentbit210C96584b6f00a464ead1953aff4b05118Parameter', {
        type: 'AWS::SSM::Parameter::Value<String>',
        default: props.ssmParameterValueawsserviceawsforfluentbit210C96584b6f00a464ead1953aff4b05118Parameter?.toString() ?? '/aws/service/aws-for-fluent-bit/2.1.0',
      }).valueAsString,
    ...
    const taskDeflogrouterLogGroup2684E4a8 = new logs.CfnLogGroup(this, 'TaskDeflogrouterLogGroup2684E4A8', {
    });
    taskDeflogrouterLogGroup2684E4a8.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.RETAIN;
    ...
    if (taskDeflogrouterLogGroup2684E4a8 == null) { throw new Error(`A combination of conditions caused 'taskDeflogrouterLogGroup2684E4a8' to be undefined. Fixit.`); }
      ...
      containerDefinitions: [
        {
          ...
          image: props.ssmParameterValueawsserviceawsforfluentbit210C96584b6f00a464ead1953aff4b05118Parameter!,
          logConfiguration: {
            logDriver: 'awslogs',
            options: {
              'awslogs-group': taskDeflogrouterLogGroup2684E4a8.ref,
      ...
      policyDocument: {
        Statement: [
          ...
          },
          {
            ...
            Effect: 'Allow',
            Resource: taskDeflogrouterLogGroup2684E4a8.attrArn,
          },
          {
            Action: 's3:GetObject',
            Effect: 'Allow',
