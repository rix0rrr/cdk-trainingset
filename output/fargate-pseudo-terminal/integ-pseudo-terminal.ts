...
export interface IntegPseudoTerminalProps extends cdk.StackProps {
  /**
...
export class IntegPseudoTerminal extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: IntegPseudoTerminalProps = {}) {
