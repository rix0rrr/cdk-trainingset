...
export interface integ-pseudo-terminalProps extends cdk.StackProps {
  /**
...
export class integ-pseudo-terminal extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: integ-pseudo-terminalProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-pseudo-terminal/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-pseudo-terminal/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-pseudo-terminal/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const serviceSecurityGroupC96ed6a7 = new ec2.CfnSecurityGroup(this, 'ServiceSecurityGroupC96ED6A7', {
      groupDescription: 'integ-pseudo-terminal/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const taskDef54694570 = new ecs.CfnTaskDefinition(this, 'TaskDef54694570', {
      ...
      cpu: '256',
      family: 'integpseudoterminalTaskDef78C54A6B',
      memory: '512',
      networkMode: 'awsvpc',
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-pseudo-terminal/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-pseudo-terminal/Vpc/PrivateSubnet2',
        },
      ],
    });
