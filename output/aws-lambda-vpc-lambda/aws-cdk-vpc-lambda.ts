...
export interface aws-cdk-vpc-lambdaProps extends cdk.StackProps {
  /**
...
export class aws-cdk-vpc-lambda extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-vpc-lambdaProps = {}) {
