...
export interface AppsyncOpensearchProps extends cdk.StackProps {
  /**
...
export class AppsyncOpensearch extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AppsyncOpensearchProps = {}) {
