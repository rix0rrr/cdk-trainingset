...
export interface Standard2Props extends cdk.StackProps {
  /**
...
export class Standard2 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard2Props = {}) {
