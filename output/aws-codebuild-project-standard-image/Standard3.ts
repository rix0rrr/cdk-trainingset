...
export interface Standard3Props extends cdk.StackProps {
  /**
...
export class Standard3 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard3Props = {}) {
