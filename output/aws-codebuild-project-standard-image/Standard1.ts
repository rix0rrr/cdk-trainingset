...
export interface Standard1Props extends cdk.StackProps {
  /**
...
export class Standard1 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard1Props = {}) {
