...
export interface Standard4Props extends cdk.StackProps {
  /**
...
export class Standard4 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard4Props = {}) {
