...
export interface Standard6Props extends cdk.StackProps {
  /**
...
export class Standard6 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard6Props = {}) {
