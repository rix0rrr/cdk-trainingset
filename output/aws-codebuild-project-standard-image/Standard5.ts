...
export interface Standard5Props extends cdk.StackProps {
  /**
...
export class Standard5 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: Standard5Props = {}) {
