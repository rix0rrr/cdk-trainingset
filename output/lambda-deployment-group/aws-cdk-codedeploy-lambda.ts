...
export interface aws-cdk-codedeploy-lambdaProps extends cdk.StackProps {
  /**
...
export class aws-cdk-codedeploy-lambda extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-codedeploy-lambdaProps = {}) {
