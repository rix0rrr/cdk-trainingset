...
export class aws-cdk-rds-s3-mysql-8-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-rds-s3-mysql-8-integProps = {}) {
    ...
    // Resources
    const databaseS3ImportRole377Bc9c0 = new iam.CfnRole(this, 'DatabaseS3ImportRole377BC9C0', {
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-s3-mysql-8-integ/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-s3-mysql-8-integ/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip4947bc00 = new ec2.CfnEIP(this, 'VPCPublicSubnet2EIP4947BC00', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-s3-mysql-8-integ/VPC/PublicSubnet2',
        },
      ],
    });

    if (databaseS3ImportRole377Bc9c0 == null) { throw new Error(`A combination of conditions caused 'databaseS3ImportRole377Bc9c0' to be undefined. Fixit.`); }
    const databaseClusterParameterGroupF2a52087 = new rds.CfnDBClusterParameterGroup(this, 'DatabaseClusterParameterGroupF2A52087', {
      description: 'Cluster parameter group for aurora-mysql8.0',
      family: 'aurora-mysql8.0',
      parameters: {
        'aws_default_s3_role': databaseS3ImportRole377Bc9c0.attrArn,
      },
    });
    ...
    const databaseS3ImportRoleDefaultPolicyA60a7342 = new iam.CfnPolicy(this, 'DatabaseS3ImportRoleDefaultPolicyA60A7342', {
      policyDocument: {
        Statement: [
          {
            Action: [
      ...
      roles: [
        databaseS3ImportRole377Bc9c0.ref,
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableBe8a6027 = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet1RouteTableBE8A6027', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-s3-mysql-8-integ/VPC/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-s3-mysql-8-integ/VPC/PrivateSubnet2',
        },
      ],
    });
    ...
    if (databaseClusterParameterGroupF2a52087 == null) { throw new Error(`A combination of conditions caused 'databaseClusterParameterGroupF2a52087' to be undefined. Fixit.`); }
    if (databaseS3ImportRole377Bc9c0 == null) { throw new Error(`A combination of conditions caused 'databaseS3ImportRole377Bc9c0' to be undefined. Fixit.`); }
    ...
    const databaseB269d8bb = new rds.CfnDBCluster(this, 'DatabaseB269D8BB', {
      ...
      associatedRoles: [
        {
          roleArn: databaseS3ImportRole377Bc9c0.attrArn,
        },
      ],
      copyTagsToSnapshot: true,
      dbClusterParameterGroupName: databaseClusterParameterGroupF2a52087.ref,
