...
export class AwsCdkElbv2Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkElbv2IntegProps = {}) {
    ...
    const sgadb53937 = new ec2.CfnSecurityGroup(this, 'SGADB53937', {
    ...
    if (sgadb53937 == null) { throw new Error(`A combination of conditions caused 'sgadb53937' to be undefined. Fixit.`); }
    ...
    lbListenerTargetGroupF04fcf6d.addDependency(vpcigwb7e252d3);
