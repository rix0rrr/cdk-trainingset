...
export interface IntegUserPoolIdpAppleProps extends cdk.StackProps {
  /**
...
export class IntegUserPoolIdpApple extends cdk.Stack {
  public readonly signInLink;

  public constructor(scope: cdk.App, id: string, props: IntegUserPoolIdpAppleProps = {}) {
