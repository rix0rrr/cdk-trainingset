...
export interface AwsCdkCodepipelineEcrSourceProps extends cdk.StackProps {
  /**
...
export class AwsCdkCodepipelineEcrSource extends cdk.Stack {
  public readonly loginCommand;
  public readonly pushCommand;
  public readonly pipelineConsoleLink;

  public constructor(scope: cdk.App, id: string, props: AwsCdkCodepipelineEcrSourceProps = {}) {
