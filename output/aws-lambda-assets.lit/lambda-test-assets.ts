...
export interface lambda-test-assetsProps extends cdk.StackProps {
  /**
...
export class lambda-test-assets extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: lambda-test-assetsProps = {}) {
