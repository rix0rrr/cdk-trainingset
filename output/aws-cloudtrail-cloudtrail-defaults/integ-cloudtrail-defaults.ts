...
export interface IntegCloudtrailDefaultsProps extends cdk.StackProps {
  /**
...
export class IntegCloudtrailDefaults extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: IntegCloudtrailDefaultsProps = {}) {
