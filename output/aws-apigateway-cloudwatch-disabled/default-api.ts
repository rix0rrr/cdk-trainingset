...
export interface DefaultApiProps extends cdk.StackProps {
  /**
...
export class DefaultApi extends cdk.Stack {
  public readonly myapiEndpoint3628Afe3;

  public constructor(scope: cdk.App, id: string, props: DefaultApiProps = {}) {
