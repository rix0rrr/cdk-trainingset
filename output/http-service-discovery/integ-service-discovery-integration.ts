...
export class integ-service-discovery-integration extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: integ-service-discovery-integrationProps = {}) {
    ...
    const namespace9B63b8c8 = new servicediscovery.CfnPrivateDnsNamespace(this, 'Namespace9B63B8C8', {
      name: 'foobar.com',
      vpc: vpcb9e5f0b4.ref,
    });
    ...
    if (vpcPrivateSubnet1Subnet8Bca10e0 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet8Bca10e0' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2SubnetCfcdaa7a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2SubnetCfcdaa7a' to be undefined. Fixit.`); }
    const vpcLink42Ed6ff0 = new apigatewayv2.CfnVpcLink(this, 'VpcLink42ED6FF0', {
    ...
    if (vpcLink42Ed6ff0 == null) { throw new Error(`A combination of conditions caused 'vpcLink42Ed6ff0' to be undefined. Fixit.`); }
    const httpProxyPrivateApiDefaultRouteDefaultIntegration002C2760 = new apigatewayv2.CfnIntegration(this, 'HttpProxyPrivateApiDefaultRouteDefaultIntegration002C2760', {
      ...
      connectionId: vpcLink42Ed6ff0.ref,
      connectionType: 'VPC_LINK',
      integrationMethod: 'ANY',
      integrationUri: namespaceServiceCabdf534.attrArn,
