...
export interface AwsFargateIntegProps extends cdk.StackProps {
  /**
...
export class AwsFargateInteg extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsFargateIntegProps = {}) {
