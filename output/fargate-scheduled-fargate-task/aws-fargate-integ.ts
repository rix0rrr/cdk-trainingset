...
export interface aws-fargate-integProps extends cdk.StackProps {
  /**
...
export class aws-fargate-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-fargate-integProps = {}) {
