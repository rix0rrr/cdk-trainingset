...
export interface integ-lambda-proxyProps extends cdk.StackProps {
  /**
...
export class integ-lambda-proxy extends cdk.Stack {
  public readonly endpoint;

  public constructor(scope: cdk.App, id: string, props: integ-lambda-proxyProps = {}) {
