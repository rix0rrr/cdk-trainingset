...
export interface cdk-integ-lambda-nodejs-esmProps extends cdk.StackProps {
  /**
...
export class cdk-integ-lambda-nodejs-esm extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: cdk-integ-lambda-nodejs-esmProps = {}) {
