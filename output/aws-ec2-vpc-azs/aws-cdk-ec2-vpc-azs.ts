...
export interface AwsCdkEc2VpcAzsProps extends cdk.StackProps {
  /**
...
export class AwsCdkEc2VpcAzs extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkEc2VpcAzsProps = {}) {
