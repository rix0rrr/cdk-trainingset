...
export interface aws-cdk-ec2-vpcProps extends cdk.StackProps {
  /**
...
export class aws-cdk-ec2-vpc extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-ec2-vpcProps = {}) {
