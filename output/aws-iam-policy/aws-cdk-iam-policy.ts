...
export interface aws-cdk-iam-policyProps extends cdk.StackProps {
  /**
...
export class aws-cdk-iam-policy extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-iam-policyProps = {}) {
