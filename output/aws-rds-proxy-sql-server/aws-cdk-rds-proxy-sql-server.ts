...
export interface AwsCdkRdsProxySqlServerProps extends cdk.StackProps {
  /**
...
export class AwsCdkRdsProxySqlServer extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkRdsProxySqlServerProps = {}) {
