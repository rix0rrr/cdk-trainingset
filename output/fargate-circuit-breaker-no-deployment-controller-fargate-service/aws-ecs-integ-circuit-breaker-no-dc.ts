...
export interface aws-ecs-integ-circuit-breaker-no-dcProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-circuit-breaker-no-dc extends cdk.Stack {
  public readonly myServiceLoadBalancerDns3a083e9f;
  public readonly myServiceServiceUrl1258c56b;

  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-circuit-breaker-no-dcProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker-no-dc/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker-no-dc/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker-no-dc/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker-no-dc/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker-no-dc/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const myServiceLbSecurityGroupFe0ed608 = new ec2.CfnSecurityGroup(this, 'myServiceLBSecurityGroupFE0ED608', {
      groupDescription: 'Automatically created Security Group for ELB awsecsintegcircuitbreakernodcmyServiceLBEE2352E2',
    ...
    const myServiceSecurityGroupC3b9d4e0 = new ec2.CfnSecurityGroup(this, 'myServiceSecurityGroupC3B9D4E0', {
      groupDescription: 'aws-ecs-integ-circuit-breaker-no-dc/myService/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const myServiceTaskDef7Fb8322a = new ecs.CfnTaskDefinition(this, 'myServiceTaskDef7FB8322A', {
      ...
      family: 'awsecsintegcircuitbreakernodcmyServiceTaskDefAF3BF4A8',
      memory: '512',
      networkMode: 'awsvpc',
    ...
    const myServiceLbSecurityGrouptoawsecsintegcircuitbreakernodcmyServiceSecurityGroup88F2483180a83c51b8 = new ec2.CfnSecurityGroupEgress(this, 'myServiceLBSecurityGrouptoawsecsintegcircuitbreakernodcmyServiceSecurityGroup88F2483180A83C51B8', {
    ...
    if (myServiceSecurityGroupC3b9d4e0 == null) { throw new Error(`A combination of conditions caused 'myServiceSecurityGroupC3b9d4e0' to be undefined. Fixit.`); }
    if (myServiceTaskDefTaskRole1C1de6cc == null) { throw new Error(`A combination of conditions caused 'myServiceTaskDefTaskRole1C1de6cc' to be undefined. Fixit.`); }
    const myServiceSecurityGroupfromawsecsintegcircuitbreakernodcmyServiceLbSecurityGroupBdcb2ae380b499f76f = new ec2.CfnSecurityGroupIngress(this, 'myServiceSecurityGroupfromawsecsintegcircuitbreakernodcmyServiceLBSecurityGroupBDCB2AE380B499F76F', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 80,
    ...
    myServiceSecurityGroupfromawsecsintegcircuitbreakernodcmyServiceLbSecurityGroupBdcb2ae380b499f76f.addDependency(myServiceTaskDefTaskRole1C1de6cc);
