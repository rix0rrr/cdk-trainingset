...
export interface cdk-integ-lambda-python-vpcProps extends cdk.StackProps {
  /**
...
export class cdk-integ-lambda-python-vpc extends cdk.Stack {
  public readonly exportsOutputRefmyhandlerD202fa8e369e8804;

  public constructor(scope: cdk.App, id: string, props: cdk-integ-lambda-python-vpcProps = {}) {
