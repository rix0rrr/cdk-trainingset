...
export interface awscdkeksimportclustertestawscdkawseksClusterResourceProvider7AA2A5F4.nestedProps extends cdk.StackProps {
}

export class awscdkeksimportclustertestawscdkawseksClusterResourceProvider7AA2A5F4.nested extends cdk.Stack {
  public readonly awscdkeksimportclustertestawscdkawseksClusterResourceProviderOnEventHandlerServiceRoleD121da23Arn;
  public readonly awscdkeksimportclustertestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRoleD61ac1e2Arn;
  public readonly awscdkeksimportclustertestawscdkawseksClusterResourceProviderframeworkonEventDee8c005Arn;

  public constructor(scope: cdk.App, id: string, props: awscdkeksimportclustertestawscdkawseksClusterResourceProvider7AA2A5F4.nestedProps = {}) {
    ...
    const providerframeworkisComplete26D7b0cb = new lambda.CfnFunction(this, 'ProviderframeworkisComplete26D7B0CB', {
      ...
      description: 'AWS CDK resource provider framework - isComplete (aws-cdk-eks-import-cluster-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
    ...
    const providerframeworkonTimeout0B47ca38 = new lambda.CfnFunction(this, 'ProviderframeworkonTimeout0B47CA38', {
      ...
      description: 'AWS CDK resource provider framework - onTimeout (aws-cdk-eks-import-cluster-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    const providerframeworkonEvent83C1d0a7 = new lambda.CfnFunction(this, 'ProviderframeworkonEvent83C1D0A7', {
      ...
      description: 'AWS CDK resource provider framework - onEvent (aws-cdk-eks-import-cluster-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    // Outputs
    this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderOnEventHandlerServiceRoleD121da23Arn = onEventHandlerServiceRole15A26729.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksimportclustertestawscdkawseksClusterResourceProviderOnEventHandlerServiceRoleD121DA23Arn', {
      key: 'awscdkeksimportclustertestawscdkawseksClusterResourceProviderOnEventHandlerServiceRoleD121DA23Arn',
      value: this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderOnEventHandlerServiceRoleD121da23Arn!.toString(),
    });
    this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRoleD61ac1e2Arn = isCompleteHandlerServiceRole5810Cc58.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksimportclustertestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRoleD61AC1E2Arn', {
      key: 'awscdkeksimportclustertestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRoleD61AC1E2Arn',
      value: this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRoleD61ac1e2Arn!.toString(),
    });
    this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderframeworkonEventDee8c005Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksimportclustertestawscdkawseksClusterResourceProviderframeworkonEventDEE8C005Arn', {
      key: 'awscdkeksimportclustertestawscdkawseksClusterResourceProviderframeworkonEventDEE8C005Arn',
      value: this.awscdkeksimportclustertestawscdkawseksClusterResourceProviderframeworkonEventDee8c005Arn!.toString(),
    });
  }
}
