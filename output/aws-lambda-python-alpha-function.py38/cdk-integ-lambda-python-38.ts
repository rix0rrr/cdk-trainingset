...
export interface CdkIntegLambdaPython38Props extends cdk.StackProps {
  /**
...
export class CdkIntegLambdaPython38 extends cdk.Stack {
  public readonly functionArn;
  public readonly exportsOutputRefmyhandlerD202fa8e369e8804;

  public constructor(scope: cdk.App, id: string, props: CdkIntegLambdaPython38Props = {}) {
