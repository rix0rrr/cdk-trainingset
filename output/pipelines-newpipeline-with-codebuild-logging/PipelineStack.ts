...
export class Pipelinestack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: PipelinestackProps = {}) {
          ...
          actions: [
            {
              ...
              name: 'colifran_cdk-pipelines-demo',
              outputArtifacts: [
                {
                  name: 'colifran_cdk_pipelines_demo_Source',
                },
              ],
              runOrder: 1,
            },
    ...
    const pipelineSourcecolifrancdkpipelinesdemoWebhookResource2Fdb39bc = new codepipeline.CfnWebhook(this, 'PipelineSourcecolifrancdkpipelinesdemoWebhookResource2FDB39BC', {
