...
export interface integ-alb-integrationProps extends cdk.StackProps {
  /**
...
export class integ-alb-integration extends cdk.Stack {
  public readonly endpoint;

  public constructor(scope: cdk.App, id: string, props: integ-alb-integrationProps = {}) {
    ...
    // Resources
    const httpProxyPrivateApiA55e154d = new apigatewayv2.CfnApi(this, 'HttpProxyPrivateApiA55E154D', {
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'integ-alb-integration/VPC',
        },
      ],
    });
    ...
    if (httpProxyPrivateApiA55e154d == null) { throw new Error(`A combination of conditions caused 'httpProxyPrivateApiA55e154d' to be undefined. Fixit.`); }
    const httpProxyPrivateApiDefaultStage18B3706e = new apigatewayv2.CfnStage(this, 'HttpProxyPrivateApiDefaultStage18B3706E', {
      apiId: httpProxyPrivateApiA55e154d.ref,
      stageName: '$default',
      autoDeploy: true,
    });
    ...
    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const lbSecurityGroup47B6f855 = new ec2.CfnSecurityGroup(this, 'lbSecurityGroup47B6F855', {
      groupDescription: 'Automatically created Security Group for ELB integalbintegrationlb02F792D5',
      securityGroupEgress: [
        {
    ...
    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const lblistenertargetGroupC7489d1e = new elasticloadbalancingv2.CfnTargetGroup(this, 'lblistenertargetGroupC7489D1E', {
      port: 80,
      protocol: 'HTTP',
    ...
    const httpProxyPrivateApiVpcLink190366Cae = new apigatewayv2.CfnVpcLink(this, 'HttpProxyPrivateApiVpcLink190366CAE', {
    ...
    if (vpcPrivateSubnet1Subnet8Bca10e0 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet8Bca10e0' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2SubnetCfcdaa7a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2SubnetCfcdaa7a' to be undefined. Fixit.`); }
    if (lbSecurityGroup47B6f855 == null) { throw new Error(`A combination of conditions caused 'lbSecurityGroup47B6f855' to be undefined. Fixit.`); }
    const lbA35910c5 = new elasticloadbalancingv2.CfnLoadBalancer(this, 'lbA35910C5', {
      ...
      scheme: 'internal',
      securityGroups: [
        lbSecurityGroup47B6f855.attrGroupId,
      ],
      subnets: [
        vpcPrivateSubnet1Subnet8Bca10e0.ref,
        vpcPrivateSubnet2SubnetCfcdaa7a.ref,
    ...
    if (lbA35910c5 == null) { throw new Error(`A combination of conditions caused 'lbA35910c5' to be undefined. Fixit.`); }
    const lblistener657Addec = new elasticloadbalancingv2.CfnListener(this, 'lblistener657ADDEC', {
      defaultActions: [
        {
          fixedResponseConfig: {
            statusCode: '200',
      ...
      loadBalancerArn: lbA35910c5.ref,
      port: 80,
      protocol: 'HTTP',
    });

    if (httpProxyPrivateApiA55e154d == null) { throw new Error(`A combination of conditions caused 'httpProxyPrivateApiA55e154d' to be undefined. Fixit.`); }
    if (httpProxyPrivateApiVpcLink190366Cae == null) { throw new Error(`A combination of conditions caused 'httpProxyPrivateApiVpcLink190366Cae' to be undefined. Fixit.`); }
    if (lblistener657Addec == null) { throw new Error(`A combination of conditions caused 'lblistener657Addec' to be undefined. Fixit.`); }
    const httpProxyPrivateApiDefaultRouteDefaultIntegration002C2760 = new apigatewayv2.CfnIntegration(this, 'HttpProxyPrivateApiDefaultRouteDefaultIntegration002C2760', {
      apiId: httpProxyPrivateApiA55e154d.ref,
      integrationType: 'HTTP_PROXY',
      connectionId: httpProxyPrivateApiVpcLink190366Cae.ref,
      connectionType: 'VPC_LINK',
      integrationMethod: 'ANY',
      integrationUri: lblistener657Addec.ref,
    ...
    if (httpProxyPrivateApiA55e154d == null) { throw new Error(`A combination of conditions caused 'httpProxyPrivateApiA55e154d' to be undefined. Fixit.`); }
    if (httpProxyPrivateApiDefaultRouteDefaultIntegration002C2760 == null) { throw new Error(`A combination of conditions caused 'httpProxyPrivateApiDefaultRouteDefaultIntegration002C2760' to be undefined. Fixit.`); }
    const httpProxyPrivateApiDefaultRoute1Bdca252 = new apigatewayv2.CfnRoute(this, 'HttpProxyPrivateApiDefaultRoute1BDCA252', {
      apiId: httpProxyPrivateApiA55e154d.ref,
      routeKey: '$default',
      authorizationType: 'NONE',
      target: [
        'integrations/',
        httpProxyPrivateApiDefaultRouteDefaultIntegration002C2760.ref,
      ].join(''),
    });
    ...
    this.endpoint = [
      'https://',
      httpProxyPrivateApiA55e154d.ref,
      '.execute-api.',
      this.region,
      '.',
      this.urlSuffix,
