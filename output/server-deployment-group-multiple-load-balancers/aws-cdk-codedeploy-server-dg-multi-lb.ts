...
export interface aws-cdk-codedeploy-server-dg-multi-lbProps extends cdk.StackProps {
  /**
...
export class aws-cdk-codedeploy-server-dg-multi-lb extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-codedeploy-server-dg-multi-lbProps = {}) {
    ...
    const asgInstanceRoleE263a41b = new iam.CfnRole(this, 'ASGInstanceRoleE263A41B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/ASG',
        },
      ],
    });

    const codeDeployGroupMultipleLoadBalancersApplication399620E3 = new codedeploy.CfnApplication(this, 'CodeDeployGroupMultipleLoadBalancersApplication399620E3', {
      computePlatform: 'Server',
    });

    const codeDeployGroupMultipleLoadBalancersRole1C8c12d4 = new iam.CfnRole(this, 'CodeDeployGroupMultipleLoadBalancersRole1C8C12D4', {
      assumeRolePolicyDocument: {
        Statement: [
          {
            Action: 'sts:AssumeRole',
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip4947bc00 = new ec2.CfnEIP(this, 'VPCPublicSubnet2EIP4947BC00', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/VPC/PublicSubnet2',
        },
      ],
    });

    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const albListenerFleetGroup008Ceee4 = new elasticloadbalancingv2.CfnTargetGroup(this, 'ALBListenerFleetGroup008CEEE4', {
      port: 80,
      protocol: 'HTTP',
    ...
    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const albSecurityGroup8B8624f8 = new ec2.CfnSecurityGroup(this, 'ALBSecurityGroup8B8624F8', {
      groupDescription: 'Automatically created Security Group for ELB awscdkcodedeployserverdgmultilbALB4D2A9235',
      securityGroupEgress: [
        {
    ...
    const asgInstanceSecurityGroup0525485D = new ec2.CfnSecurityGroup(this, 'ASGInstanceSecurityGroup0525485D', {
      groupDescription: 'aws-cdk-codedeploy-server-dg-multi-lb/ASG/InstanceSecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const elbSecurityGroupF148fd2e = new ec2.CfnSecurityGroup(this, 'ELBSecurityGroupF148FD2E', {
      groupDescription: 'aws-cdk-codedeploy-server-dg-multi-lb/ELB/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '255.255.255.255/32',
          description: 'Disallow all traffic',
    ...
    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const nlbListenerFleetGroupB882ec86 = new elasticloadbalancingv2.CfnTargetGroup(this, 'NLBListenerFleetGroupB882EC86', {
      port: 80,
      protocol: 'TCP',
      vpcId: vpcb9e5f0b4.ref,
    });
    ...
    const vpcPrivateSubnet1RouteTableBe8a6027 = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet1RouteTableBE8A6027', {
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/VPC/PrivateSubnet1',
        },
      ],
      vpcId: vpcb9e5f0b4.ref,
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-codedeploy-server-dg-multi-lb/VPC/PrivateSubnet2',
        },
      ],
      vpcId: vpcb9e5f0b4.ref,
    });
    ...
    if (albSecurityGroup8B8624f8 == null) { throw new Error(`A combination of conditions caused 'albSecurityGroup8B8624f8' to be undefined. Fixit.`); }
    ...
    const albaee750d2 = new elasticloadbalancingv2.CfnLoadBalancer(this, 'ALBAEE750D2', {
      ...
      scheme: 'internal',
      securityGroups: [
        albSecurityGroup8B8624f8.attrGroupId,
      ],
      subnets: [
        ...
        tagSpecifications: [
          {
            ...
            tags: [
              {
                key: 'Name',
                value: 'aws-cdk-codedeploy-server-dg-multi-lb/ASG/LaunchTemplate',
              },
            ],
          },
          {
    ...
    if (vpcPrivateSubnet1Subnet8Bca10e0 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet8Bca10e0' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2SubnetCfcdaa7a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2SubnetCfcdaa7a' to be undefined. Fixit.`); }
    const nlb55158f82 = new elasticloadbalancingv2.CfnLoadBalancer(this, 'NLB55158F82', {
      loadBalancerAttributes: [
        {
          key: 'deletion_protection.enabled',
          value: 'false',
    ...
    if (albaee750d2 == null) { throw new Error(`A combination of conditions caused 'albaee750d2' to be undefined. Fixit.`); }
    if (albListenerFleetGroup008Ceee4 == null) { throw new Error(`A combination of conditions caused 'albListenerFleetGroup008Ceee4' to be undefined. Fixit.`); }
    const albListener3B99ff85 = new elasticloadbalancingv2.CfnListener(this, 'ALBListener3B99FF85', {
      defaultActions: [
        {
          targetGroupArn: albListenerFleetGroup008Ceee4.ref,
          type: 'forward',
        },
      ],
      loadBalancerArn: albaee750d2.ref,
      port: 80,
      protocol: 'HTTP',
    });
    ...
    if (nlb55158f82 == null) { throw new Error(`A combination of conditions caused 'nlb55158f82' to be undefined. Fixit.`); }
    if (nlbListenerFleetGroupB882ec86 == null) { throw new Error(`A combination of conditions caused 'nlbListenerFleetGroupB882ec86' to be undefined. Fixit.`); }
    const nlbListener96C8170f = new elasticloadbalancingv2.CfnListener(this, 'NLBListener96C8170F', {
      defaultActions: [
        {
          targetGroupArn: nlbListenerFleetGroupB882ec86.ref,
          type: 'forward',
        },
      ],
      loadBalancerArn: nlb55158f82.ref,
      port: 80,
      protocol: 'TCP',
    });
    ...
    if (codeDeployGroupMultipleLoadBalancersApplication399620E3 == null) { throw new Error(`A combination of conditions caused 'codeDeployGroupMultipleLoadBalancersApplication399620E3' to be undefined. Fixit.`); }
    if (codeDeployGroupMultipleLoadBalancersRole1C8c12d4 == null) { throw new Error(`A combination of conditions caused 'codeDeployGroupMultipleLoadBalancersRole1C8c12d4' to be undefined. Fixit.`); }
    if (elbf276b85d == null) { throw new Error(`A combination of conditions caused 'elbf276b85d' to be undefined. Fixit.`); }
    if (nlbListenerFleetGroupB882ec86 == null) { throw new Error(`A combination of conditions caused 'nlbListenerFleetGroupB882ec86' to be undefined. Fixit.`); }
    const codeDeployGroupMultipleLoadBalancers49Cda4c4 = new codedeploy.CfnDeploymentGroup(this, 'CodeDeployGroupMultipleLoadBalancers49CDA4C4', {
      alarmConfiguration: {
        enabled: false,
      },
      applicationName: codeDeployGroupMultipleLoadBalancersApplication399620E3.ref,
      ...
      loadBalancerInfo: {
        ...
        targetGroupInfoList: [
          {
            name: albListenerFleetGroup008Ceee4.attrTargetGroupName,
          },
          {
            name: nlbListenerFleetGroupB882ec86.attrTargetGroupName,
          },
        ],
      },
      serviceRoleArn: codeDeployGroupMultipleLoadBalancersRole1C8c12d4.attrArn,
    });
