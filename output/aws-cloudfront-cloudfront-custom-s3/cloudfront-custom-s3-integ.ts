...
export interface CloudfrontCustomS3IntegProps extends cdk.StackProps {
  /**
...
export class CloudfrontCustomS3Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CloudfrontCustomS3IntegProps = {}) {
