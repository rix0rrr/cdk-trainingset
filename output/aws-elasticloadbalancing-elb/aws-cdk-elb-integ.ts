...
export interface aws-cdk-elb-integProps extends cdk.StackProps {
  /**
...
export class aws-cdk-elb-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-elb-integProps = {}) {
