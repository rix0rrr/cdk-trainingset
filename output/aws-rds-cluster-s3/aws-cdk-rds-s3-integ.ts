...
export interface AwsCdkRdsS3IntegProps extends cdk.StackProps {
  /**
...
export class AwsCdkRdsS3Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkRdsS3IntegProps = {}) {
