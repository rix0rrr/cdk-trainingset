...
export interface aws-cdk-rds-s3-integProps extends cdk.StackProps {
  /**
...
export class aws-cdk-rds-s3-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-rds-s3-integProps = {}) {
    ...
    exportBucket4E99310e.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.RETAIN;

    const importBucketBaf3a8e9 = new s3.CfnBucket(this, 'ImportBucketBAF3A8E9', {
    });
    importBucketBaf3a8e9.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.RETAIN;
