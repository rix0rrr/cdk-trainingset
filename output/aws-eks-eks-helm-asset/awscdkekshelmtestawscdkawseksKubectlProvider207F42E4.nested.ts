...
export interface awscdkekshelmtestawscdkawseksKubectlProvider207F42E4.nestedProps extends cdk.StackProps {
  /**
   */
  readonly referencetoawscdkekshelmtestKubectlLayer2638D675Ref: string;
  /**
   */
  readonly referencetoawscdkekshelmtestClusterKubectlHandlerRoleF7b0b227Arn: string;
  /**
   */
  readonly referencetoawscdkekshelmtestVpcPrivateSubnet1Subnet3D2b5c0bRef: string;
  /**
   */
  readonly referencetoawscdkekshelmtestVpcPrivateSubnet2SubnetF5e4afe9Ref: string;
  /**
   */
  readonly referencetoawscdkekshelmtestCluster35Ba672bClusterSecurityGroupId: string;
}

export class awscdkekshelmtestawscdkawseksKubectlProvider207F42E4.nested extends cdk.Stack {
  public readonly awscdkekshelmtestawscdkawseksKubectlProviderframeworkonEvent9D93c644Arn;

  public constructor(scope: cdk.App, id: string, props: awscdkekshelmtestawscdkawseksKubectlProvider207F42E4.nestedProps) {
    ...
    const handler886Cb40b = new lambda.CfnFunction(this, 'Handler886CB40B', {
      ...
      layers: [
        ...
        props.referencetoawscdkekshelmtestKubectlLayer2638D675Ref!,
      ],
      memorySize: 1024,
      role: props.referencetoawscdkekshelmtestClusterKubectlHandlerRoleF7b0b227Arn!,
      runtime: 'python3.10',
      timeout: 900,
      vpcConfig: {
        securityGroupIds: [
          props.referencetoawscdkekshelmtestCluster35Ba672bClusterSecurityGroupId!,
        ],
        subnetIds: [
          props.referencetoawscdkekshelmtestVpcPrivateSubnet1Subnet3D2b5c0bRef!,
          props.referencetoawscdkekshelmtestVpcPrivateSubnet2SubnetF5e4afe9Ref!,
        ],
      },
    });
    ...
    // Outputs
    this.awscdkekshelmtestawscdkawseksKubectlProviderframeworkonEvent9D93c644Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkekshelmtestawscdkawseksKubectlProviderframeworkonEvent9D93C644Arn', {
      key: 'awscdkekshelmtestawscdkawseksKubectlProviderframeworkonEvent9D93C644Arn',
      value: this.awscdkekshelmtestawscdkawseksKubectlProviderframeworkonEvent9D93c644Arn!.toString(),
    });
  }
}
