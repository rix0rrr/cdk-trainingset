...
export interface awscdkekshelmtestawscdkawseksClusterResourceProviderB64048CD.nestedProps extends cdk.StackProps {
}

export class awscdkekshelmtestawscdkawseksClusterResourceProviderB64048CD.nested extends cdk.Stack {
  public readonly awscdkekshelmtestawscdkawseksClusterResourceProviderOnEventHandlerServiceRole53C6a0aeArn;
  public readonly awscdkekshelmtestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole12F3dec7Arn;
  public readonly awscdkekshelmtestawscdkawseksClusterResourceProviderframeworkonEventFcdc8710Arn;

  public constructor(scope: cdk.App, id: string, props: awscdkekshelmtestawscdkawseksClusterResourceProviderB64048CD.nestedProps = {}) {
    ...
    // Outputs
    this.awscdkekshelmtestawscdkawseksClusterResourceProviderOnEventHandlerServiceRole53C6a0aeArn = onEventHandlerServiceRole15A26729.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkekshelmtestawscdkawseksClusterResourceProviderOnEventHandlerServiceRole53C6A0AEArn', {
      key: 'awscdkekshelmtestawscdkawseksClusterResourceProviderOnEventHandlerServiceRole53C6A0AEArn',
      value: this.awscdkekshelmtestawscdkawseksClusterResourceProviderOnEventHandlerServiceRole53C6a0aeArn!.toString(),
    });
    this.awscdkekshelmtestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole12F3dec7Arn = isCompleteHandlerServiceRole5810Cc58.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkekshelmtestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole12F3DEC7Arn', {
      key: 'awscdkekshelmtestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole12F3DEC7Arn',
      value: this.awscdkekshelmtestawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole12F3dec7Arn!.toString(),
    });
    this.awscdkekshelmtestawscdkawseksClusterResourceProviderframeworkonEventFcdc8710Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkekshelmtestawscdkawseksClusterResourceProviderframeworkonEventFCDC8710Arn', {
      key: 'awscdkekshelmtestawscdkawseksClusterResourceProviderframeworkonEventFCDC8710Arn',
      value: this.awscdkekshelmtestawscdkawseksClusterResourceProviderframeworkonEventFcdc8710Arn!.toString(),
    });
  }
}
