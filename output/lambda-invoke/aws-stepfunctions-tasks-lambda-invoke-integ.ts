...
export interface aws-stepfunctions-tasks-lambda-invoke-integProps extends cdk.StackProps {
  /**
...
export class aws-stepfunctions-tasks-lambda-invoke-integ extends cdk.Stack {
  public readonly stateMachineArn;
  public readonly exportsOutputRefStateMachine2E01a3a5ba46f753;

  public constructor(scope: cdk.App, id: string, props: aws-stepfunctions-tasks-lambda-invoke-integProps = {}) {
    ...
    const stateMachine2E01a3a5 = new stepfunctions.CfnStateMachine(this, 'StateMachine2E01A3A5', {
      definitionString: [
        '{\"StartAt\":\"Invoke Handler\",\"States\":{\"Invoke Handler\":{\"Next\":\"Check the job state\",\"Retry\":[{\"ErrorEquals\":[\"Lambda.ClientExecutionTimeoutException\",\"Lambda.ServiceException\",\"Lambda.AWSLambdaException\",\"Lambda.SdkClientException\"],\"IntervalSeconds\":2,\"MaxAttempts\":6,\"BackoffRate\":2}],\"Type\":\"Task\",\"OutputPath\":\"$.Payload\",\"Resource\":\"arn:',
        this.partition,
        ':states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"',
        submitJobLambdaEfb00f3c.attrArn,
        '\",\"Payload\":{\"execId.$\":\"$$.Execution.Id\",\"execInput.$\":\"$$.Execution.Input\",\"execName.$\":\"$$.Execution.Name\",\"execRoleArn.$\":\"$$.Execution.RoleArn\",\"execStartTime.$\":\"$$.Execution.StartTime\",\"stateEnteredTime.$\":\"$$.State.EnteredTime\",\"stateName.$\":\"$$.State.Name\",\"stateRetryCount.$\":\"$$.State.RetryCount\",\"stateMachineId.$\":\"$$.StateMachine.Id\",\"stateMachineName.$\":\"$$.StateMachine.Name\"}}},\"Check the job state\":{\"Next\":\"Job Complete?\",\"Retry\":[{\"ErrorEquals\":[\"Lambda.ClientExecutionTimeoutException\",\"Lambda.ServiceException\",\"Lambda.AWSLambdaException\",\"Lambda.SdkClientException\"],\"IntervalSeconds\":2,\"MaxAttempts\":6,\"BackoffRate\":2}],\"Type\":\"Task\",\"ResultSelector\":{\"status.$\":\"$.Payload.status\"},\"Resource\":\"arn:',
        this.partition,
        ':states:::lambda:invoke\",\"Parameters\":{\"FunctionName\":\"',
        checkJobStateLambda4618B7b7.attrArn,
    ...
    new cdk.CfnOutput(this, 'CfnOutputExportsOutputRefStateMachine2E01A3A5BA46F753', {
      ...
      exportName: 'aws-stepfunctions-tasks-lambda-invoke-integ:ExportsOutputRefStateMachine2E01A3A5BA46F753',
