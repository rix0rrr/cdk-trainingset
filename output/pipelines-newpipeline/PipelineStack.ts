...
export class Pipelinestack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: PipelinestackProps = {}) {
    ...
    const pipelineSourcerix0rrrcdkpipelinesdemoWebhookResourceDb0c1bca = new codepipeline.CfnWebhook(this, 'PipelineSourcerix0rrrcdkpipelinesdemoWebhookResourceDB0C1BCA', {
