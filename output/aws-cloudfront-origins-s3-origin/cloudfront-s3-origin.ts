...
export interface CloudfrontS3OriginProps extends cdk.StackProps {
  /**
...
export class CloudfrontS3Origin extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CloudfrontS3OriginProps = {}) {
