...
export interface CdkAmplifyCodecommitAppProps extends cdk.StackProps {
  /**
...
export class CdkAmplifyCodecommitApp extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CdkAmplifyCodecommitAppProps = {}) {
