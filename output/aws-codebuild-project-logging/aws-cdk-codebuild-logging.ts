...
export interface AwsCdkCodebuildLoggingProps extends cdk.StackProps {
  /**
...
export class AwsCdkCodebuildLogging extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkCodebuildLoggingProps = {}) {
