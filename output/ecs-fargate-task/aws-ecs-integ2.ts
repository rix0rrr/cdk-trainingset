...
export interface AwsEcsInteg2Props extends cdk.StackProps {
  /**
...
export class AwsEcsInteg2 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsEcsInteg2Props = {}) {
