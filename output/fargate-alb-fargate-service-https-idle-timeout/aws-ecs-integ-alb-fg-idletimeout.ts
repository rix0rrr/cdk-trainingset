...
export interface aws-ecs-integ-alb-fg-idletimeoutProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-alb-fg-idletimeout extends cdk.Stack {
  public readonly myServiceLoadBalancerDns3a083e9f;
  public readonly myServiceServiceUrl1258c56b;

  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-alb-fg-idletimeoutProps = {}) {
