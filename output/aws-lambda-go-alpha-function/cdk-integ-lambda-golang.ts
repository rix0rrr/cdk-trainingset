...
export interface CdkIntegLambdaGolangProps extends cdk.StackProps {
  /**
...
export class CdkIntegLambdaGolang extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: CdkIntegLambdaGolangProps = {}) {
