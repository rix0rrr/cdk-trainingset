...
export class aws-ecs-integ-ecs extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-ecsProps = {}) {
    ...
    const ecsClusterDefaultAutoScalingGroupInstanceSecurityGroupfromawsecsintegecsLbSecurityGroup7Da9012980800b834eb8 = new ec2.CfnSecurityGroupIngress(this, 'EcsClusterDefaultAutoScalingGroupInstanceSecurityGroupfromawsecsintegecsLBSecurityGroup7DA9012980800B834EB8', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 8080,
      groupId: ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231.attrGroupId,
    ...
    if (ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231 == null) { throw new Error(`A combination of conditions caused 'ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231' to be undefined. Fixit.`); }
    if (lbSecurityGroup8A41ea2b == null) { throw new Error(`A combination of conditions caused 'lbSecurityGroup8A41ea2b' to be undefined. Fixit.`); }
    const lbSecurityGrouptoawsecsintegecsEcsClusterDefaultAutoScalingGroupInstanceSecurityGroupE3116410808033398dfa = new ec2.CfnSecurityGroupEgress(this, 'LBSecurityGrouptoawsecsintegecsEcsClusterDefaultAutoScalingGroupInstanceSecurityGroupE3116410808033398DFA', {
      groupId: lbSecurityGroup8A41ea2b.attrGroupId,
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      destinationSecurityGroupId: ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231.attrGroupId,
      fromPort: 8080,
      toPort: 8080,
    });
