  ...
  public constructor(scope: cdk.App, id: string, props: KafkastoragemodeteststackProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'KafkaStorageModeTestStack/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'KafkaStorageModeTestStack/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'KafkaStorageModeTestStack/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      tags: [
        {
          key: 'Name',
          value: 'KafkaStorageModeTestStack/Vpc/PrivateSubnet1',
        },
      ],
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      tags: [
        {
          key: 'Name',
          value: 'KafkaStorageModeTestStack/Vpc/PrivateSubnet2',
        },
      ],
      vpcId: vpc8378Eb38.ref,
    });
    ...
    if (vpc8378Eb38 == null) { throw new Error(`A combination of conditions caused 'vpc8378Eb38' to be undefined. Fixit.`); }
    const storageModelocalSecurityGroupFd0a95de = new ec2.CfnSecurityGroup(this, 'storageModelocalSecurityGroupFD0A95DE', {
    ...
    if (vpc8378Eb38 == null) { throw new Error(`A combination of conditions caused 'vpc8378Eb38' to be undefined. Fixit.`); }
    const storageModetieredSecurityGroupAaf9f00e = new ec2.CfnSecurityGroup(this, 'storageModetieredSecurityGroupAAF9F00E', {
      groupDescription: 'MSK security group',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    if (vpcPrivateSubnet1Subnet536B997a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet536B997a' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2Subnet3788Aaa1 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2Subnet3788Aaa1' to be undefined. Fixit.`); }
    if (storageModelocalSecurityGroupFd0a95de == null) { throw new Error(`A combination of conditions caused 'storageModelocalSecurityGroupFd0a95de' to be undefined. Fixit.`); }
    const storageModelocal9Cef347d = new msk.CfnCluster(this, 'storageModelocal9CEF347D', {
      brokerNodeGroupInfo: {
        clientSubnets: [
        ...
        securityGroups: [
          storageModelocalSecurityGroupFd0a95de.attrGroupId,
        ],
        storageInfo: {
          ebsStorageInfo: {
            volumeSize: 1000,
    ...
    storageModelocal9Cef347d.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.DELETE;

    if (vpcPrivateSubnet1Subnet536B997a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet536B997a' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2Subnet3788Aaa1 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2Subnet3788Aaa1' to be undefined. Fixit.`); }
    if (storageModetieredSecurityGroupAaf9f00e == null) { throw new Error(`A combination of conditions caused 'storageModetieredSecurityGroupAaf9f00e' to be undefined. Fixit.`); }
    const storageModetieredB9ede2df = new msk.CfnCluster(this, 'storageModetieredB9EDE2DF', {
      brokerNodeGroupInfo: {
        clientSubnets: [
          vpcPrivateSubnet1Subnet536B997a.ref,
          vpcPrivateSubnet2Subnet3788Aaa1.ref,
        ...
        instanceType: 'kafka.m5.large',
        securityGroups: [
          storageModetieredSecurityGroupAaf9f00e.attrGroupId,
        ],
        storageInfo: {
          ebsStorageInfo: {
            volumeSize: 1000,
    ...
    storageModetieredB9ede2df.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.DELETE;
