  ...
  public constructor(scope: cdk.App, id: string, props: cdk-integ-lambda-bundlingProps = {}) {
    ...
    const function76856677 = new lambda.CfnFunction(this, 'Function76856677', {
      code: {
        ...
        s3Key: '4509b6f48df5f7f88801598f6f8473b4e0feac7f73d4f677d81e4cb461cefa45.zip',
      },
    ...
    new cdk.CfnOutput(this, 'CfnOutputExportsOutputRefFunction76856677C48862D5', {
      ...
      exportName: 'cdk-integ-lambda-bundling:ExportsOutputRefFunction76856677C48862D5',
