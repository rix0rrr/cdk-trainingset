  ...
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-alb-fg-httpsProps = {}) {
    ...
    const myServiceCertificate152F9dda = new certificatemanager.CfnCertificate(this, 'myServiceCertificate152F9DDA', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb-fg-https/myService/Certificate',
        },
      ],
    ...
    const myServiceLbSecurityGrouptoawsecsintegalbfghttpsmyServiceSecurityGroup49C558ad803fb613ff = new ec2.CfnSecurityGroupEgress(this, 'myServiceLBSecurityGrouptoawsecsintegalbfghttpsmyServiceSecurityGroup49C558AD803FB613FF', {
    ...
    if (myServiceTaskDefTaskRole1C1de6cc == null) { throw new Error(`A combination of conditions caused 'myServiceTaskDefTaskRole1C1de6cc' to be undefined. Fixit.`); }
    if (myServiceTaskDefTaskRoleDefaultPolicyD48473c0 == null) { throw new Error(`A combination of conditions caused 'myServiceTaskDefTaskRoleDefaultPolicyD48473c0' to be undefined. Fixit.`); }
    const myServiceSecurityGroupfromawsecsintegalbfghttpsmyServiceLbSecurityGroupA934af89808e9fb7a3 = new ec2.CfnSecurityGroupIngress(this, 'myServiceSecurityGroupfromawsecsintegalbfghttpsmyServiceLBSecurityGroupA934AF89808E9FB7A3', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 80,
    ...
    myServiceSecurityGroupfromawsecsintegalbfghttpsmyServiceLbSecurityGroupA934af89808e9fb7a3.addDependency(myServiceTaskDefTaskRoleDefaultPolicyD48473c0);
    myServiceSecurityGroupfromawsecsintegalbfghttpsmyServiceLbSecurityGroupA934af89808e9fb7a3.addDependency(myServiceTaskDefTaskRole1C1de6cc);
