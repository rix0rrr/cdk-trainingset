...
export interface aws-cdk-kms-1Props extends cdk.StackProps {
  /**
...
export class aws-cdk-kms-1 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-kms-1Props = {}) {
