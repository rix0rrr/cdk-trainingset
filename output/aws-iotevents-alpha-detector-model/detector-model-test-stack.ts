...
export interface DetectorModelTestStackProps extends cdk.StackProps {
  /**
...
export class DetectorModelTestStack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: DetectorModelTestStackProps = {}) {
