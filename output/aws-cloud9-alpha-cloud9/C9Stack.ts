...
export interface C9StackProps extends cdk.StackProps {
  /**
...
export class C9Stack extends cdk.Stack {
  public readonly url;
  public readonly arn;

  public constructor(scope: cdk.App, id: string, props: C9StackProps = {}) {
    ...
    const c9EnvF05fc3be = new cloud9.CfnEnvironmentEC2(this, 'C9EnvF05FC3BE', {
      ...
      repositories: [
        {
          pathComponent: '/foo',
          repositoryUrl: repo02Ac86cf.attrCloneUrlHttp,
        },
      ],
