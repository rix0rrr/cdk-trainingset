...
export class Awscdkeksclusteripv6Testawscdkawseksclusterresourceproviderac8Db286Nested extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: Awscdkeksclusteripv6Testawscdkawseksclusterresourceproviderac8Db286NestedProps = {}) {
    ...
    const providerframeworkisComplete26D7b0cb = new lambda.CfnFunction(this, 'ProviderframeworkisComplete26D7B0CB', {
      ...
      description: 'AWS CDK resource provider framework - isComplete (aws-cdk-eks-cluster-ipv6-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
    ...
    const providerframeworkonTimeout0B47ca38 = new lambda.CfnFunction(this, 'ProviderframeworkonTimeout0B47CA38', {
      ...
      description: 'AWS CDK resource provider framework - onTimeout (aws-cdk-eks-cluster-ipv6-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    const providerframeworkonEvent83C1d0a7 = new lambda.CfnFunction(this, 'ProviderframeworkonEvent83C1D0A7', {
      ...
      description: 'AWS CDK resource provider framework - onEvent (aws-cdk-eks-cluster-ipv6-test/@aws-cdk--aws-eks.ClusterResourceProvider/Provider)',
      environment: {
        variables: {
          'USER_ON_EVENT_FUNCTION_ARN': onEventHandler42Bebae0.attrArn,
          'USER_IS_COMPLETE_FUNCTION_ARN': isCompleteHandler7073F4da.attrArn,
    ...
    // Outputs
    this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderOnEventHandlerServiceRole6C18ae9aArn = onEventHandlerServiceRole15A26729.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusteripv6testawscdkawseksClusterResourceProviderOnEventHandlerServiceRole6C18AE9AArn', {
      key: 'awscdkeksclusteripv6testawscdkawseksClusterResourceProviderOnEventHandlerServiceRole6C18AE9AArn',
      value: this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderOnEventHandlerServiceRole6C18ae9aArn!.toString(),
    });
    this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole1F912062Arn = isCompleteHandlerServiceRole5810Cc58.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusteripv6testawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole1F912062Arn', {
      key: 'awscdkeksclusteripv6testawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole1F912062Arn',
      value: this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderIsCompleteHandlerServiceRole1F912062Arn!.toString(),
    });
    this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderframeworkonEvent27Ea7496Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkeksclusteripv6testawscdkawseksClusterResourceProviderframeworkonEvent27EA7496Arn', {
      key: 'awscdkeksclusteripv6testawscdkawseksClusterResourceProviderframeworkonEvent27EA7496Arn',
      value: this.awscdkeksclusteripv6testawscdkawseksClusterResourceProviderframeworkonEvent27Ea7496Arn!.toString(),
    });
  }
}
