...
export interface AwsCdkCloudwatchProps extends cdk.StackProps {
  /**
...
export class AwsCdkCloudwatch extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkCloudwatchProps = {}) {
