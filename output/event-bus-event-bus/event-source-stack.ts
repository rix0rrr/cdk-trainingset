...
export interface event-source-stackProps extends cdk.StackProps {
  /**
...
export class event-source-stack extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: event-source-stackProps = {}) {
