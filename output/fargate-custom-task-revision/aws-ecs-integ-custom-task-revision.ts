...
export class AwsEcsIntegCustomTaskRevision extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegCustomTaskRevisionProps = {}) {
    ...
    // Resources
    const fargateCpCluster668E71f2 = new ecs.CfnCluster(this, 'FargateCPCluster668E71F2', {
    });
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-custom-task-revision/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-custom-task-revision/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-custom-task-revision/Vpc/PublicSubnet2',
        },
      ],
    });

    if (fargateCpCluster668E71f2 == null) { throw new Error(`A combination of conditions caused 'fargateCpCluster668E71f2' to be undefined. Fixit.`); }
    const fargateCpClusterBfd66a36 = new ecs.CfnClusterCapacityProviderAssociations(this, 'FargateCPClusterBFD66A36', {
      capacityProviders: [
        'FARGATE',
        'FARGATE_SPOT',
      ],
      cluster: fargateCpCluster668E71f2.ref,
    ...
    const taskDef54694570 = new ecs.CfnTaskDefinition(this, 'TaskDef54694570', {
      ...
      cpu: '256',
      family: 'awsecsintegcustomtaskrevisionTaskDef9F1555EB',
      memory: '512',
      networkMode: 'awsvpc',
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-custom-task-revision/Vpc/PrivateSubnet1',
        },
      ],
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-custom-task-revision/Vpc/PrivateSubnet2',
        },
      ],
      vpcId: vpc8378Eb38.ref,
    });
    ...
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    if (vpc8378Eb38 == null) { throw new Error(`A combination of conditions caused 'vpc8378Eb38' to be undefined. Fixit.`); }
    const fargateServiceFirstSecurityGroup79D2d2fe = new ec2.CfnSecurityGroup(this, 'FargateServiceFirstSecurityGroup79D2D2FE', {
      groupDescription: 'aws-ecs-integ-custom-task-revision/FargateServiceFirst/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    fargateServiceFirstSecurityGroup79D2d2fe.addDependency(taskDef54694570);
    fargateServiceFirstSecurityGroup79D2d2fe.addDependency(taskDefTaskRole1Edb4a67);

    if (taskDef54694570 == null) { throw new Error(`A combination of conditions caused 'taskDef54694570' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    if (vpc8378Eb38 == null) { throw new Error(`A combination of conditions caused 'vpc8378Eb38' to be undefined. Fixit.`); }
    const fargateServiceLatestSecurityGroupAae45690 = new ec2.CfnSecurityGroup(this, 'FargateServiceLatestSecurityGroupAAE45690', {
      groupDescription: 'aws-ecs-integ-custom-task-revision/FargateServiceLatest/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
          description: 'Allow all outbound traffic by default',
    ...
    fargateServiceLatestSecurityGroupAae45690.addDependency(taskDef54694570);
    fargateServiceLatestSecurityGroupAae45690.addDependency(taskDefTaskRole1Edb4a67);
    ...
    if (fargateCpCluster668E71f2 == null) { throw new Error(`A combination of conditions caused 'fargateCpCluster668E71f2' to be undefined. Fixit.`); }
    if (fargateServiceFirstSecurityGroup79D2d2fe == null) { throw new Error(`A combination of conditions caused 'fargateServiceFirstSecurityGroup79D2d2fe' to be undefined. Fixit.`); }
    if (taskDef54694570 == null) { throw new Error(`A combination of conditions caused 'taskDef54694570' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet1Subnet536B997a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet536B997a' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2Subnet3788Aaa1 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2Subnet3788Aaa1' to be undefined. Fixit.`); }
    const fargateServiceFirstService0D82f989 = new ecs.CfnService(this, 'FargateServiceFirstService0D82F989', {
      cluster: fargateCpCluster668E71f2.ref,
      ...
      networkConfiguration: {
        awsvpcConfiguration: {
          ...
          securityGroups: [
            fargateServiceFirstSecurityGroup79D2d2fe.attrGroupId,
          ],
          subnets: [
      ...
      taskDefinition: 'awsecsintegcustomtaskrevisionTaskDef9F1555EB:1',
    });
    fargateServiceFirstService0D82f989.addDependency(taskDef54694570);
    fargateServiceFirstService0D82f989.addDependency(taskDefTaskRole1Edb4a67);

    if (fargateCpCluster668E71f2 == null) { throw new Error(`A combination of conditions caused 'fargateCpCluster668E71f2' to be undefined. Fixit.`); }
    if (fargateServiceLatestSecurityGroupAae45690 == null) { throw new Error(`A combination of conditions caused 'fargateServiceLatestSecurityGroupAae45690' to be undefined. Fixit.`); }
    if (taskDef54694570 == null) { throw new Error(`A combination of conditions caused 'taskDef54694570' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet1Subnet536B997a == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet1Subnet536B997a' to be undefined. Fixit.`); }
    if (vpcPrivateSubnet2Subnet3788Aaa1 == null) { throw new Error(`A combination of conditions caused 'vpcPrivateSubnet2Subnet3788Aaa1' to be undefined. Fixit.`); }
    const fargateServiceLatestService58B1bc30 = new ecs.CfnService(this, 'FargateServiceLatestService58B1BC30', {
      cluster: fargateCpCluster668E71f2.ref,
      deploymentConfiguration: {
        alarms: {
          alarmNames: [
      ...
      networkConfiguration: {
        awsvpcConfiguration: {
          assignPublicIp: 'DISABLED',
          securityGroups: [
            fargateServiceLatestSecurityGroupAae45690.attrGroupId,
          ],
          subnets: [
            vpcPrivateSubnet1Subnet536B997a.ref,
            vpcPrivateSubnet2Subnet3788Aaa1.ref,
      ...
      taskDefinition: 'awsecsintegcustomtaskrevisionTaskDef9F1555EB',
    });
    fargateServiceLatestService58B1bc30.addDependency(taskDef54694570);
    fargateServiceLatestService58B1bc30.addDependency(taskDefTaskRole1Edb4a67);
