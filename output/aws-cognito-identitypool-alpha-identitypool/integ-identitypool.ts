...
export interface integ-identitypoolProps extends cdk.StackProps {
  /**
...
export class integ-identitypool extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: integ-identitypoolProps = {}) {
