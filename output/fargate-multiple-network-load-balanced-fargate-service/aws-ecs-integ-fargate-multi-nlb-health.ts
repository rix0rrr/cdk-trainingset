...
export interface aws-ecs-integ-fargate-multi-nlb-healthProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-fargate-multi-nlb-health extends cdk.Stack {
  public readonly myServiceLoadBalancerDnSlb1341Ee21a;
  public readonly myServiceLoadBalancerDnSlb2Ddce46c8;

  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-fargate-multi-nlb-healthProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-fargate-multi-nlb-health/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-fargate-multi-nlb-health/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-fargate-multi-nlb-health/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-fargate-multi-nlb-health/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-fargate-multi-nlb-health/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const myServiceSecurityGroupC3b9d4e0 = new ec2.CfnSecurityGroup(this, 'myServiceSecurityGroupC3B9D4E0', {
      groupDescription: 'aws-ecs-integ-fargate-multi-nlb-health/myService/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const myServiceTaskDef7Fb8322a = new ecs.CfnTaskDefinition(this, 'myServiceTaskDef7FB8322A', {
      ...
      family: 'awsecsintegfargatemultinlbhealthmyServiceTaskDefB1B291FD',
      memory: '512',
      networkMode: 'awsvpc',
