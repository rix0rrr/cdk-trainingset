  ...
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegCircuitBreakerProps = {}) {
    ...
    const vpc8378Eb38 = new ec2.CfnVPC(this, 'Vpc8378EB38', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker/Vpc',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-circuit-breaker/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const myServiceLbSecurityGroupFe0ed608 = new ec2.CfnSecurityGroup(this, 'myServiceLBSecurityGroupFE0ED608', {
      groupDescription: 'Automatically created Security Group for ELB awsecsintegcircuitbreakermyServiceLBAAAA00FA',
    ...
    const myServiceSecurityGroupC3b9d4e0 = new ec2.CfnSecurityGroup(this, 'myServiceSecurityGroupC3B9D4E0', {
      groupDescription: 'aws-ecs-integ-circuit-breaker/myService/Service/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const myServiceLbSecurityGrouptoawsecsintegcircuitbreakermyServiceSecurityGroup9B2b6c61808d727f20 = new ec2.CfnSecurityGroupEgress(this, 'myServiceLBSecurityGrouptoawsecsintegcircuitbreakermyServiceSecurityGroup9B2B6C61808D727F20', {
    ...
    if (myServiceSecurityGroupC3b9d4e0 == null) { throw new Error(`A combination of conditions caused 'myServiceSecurityGroupC3b9d4e0' to be undefined. Fixit.`); }
    if (myServiceTaskDefTaskRole1C1de6cc == null) { throw new Error(`A combination of conditions caused 'myServiceTaskDefTaskRole1C1de6cc' to be undefined. Fixit.`); }
    const myServiceSecurityGroupfromawsecsintegcircuitbreakermyServiceLbSecurityGroupB690840480bbff8b33 = new ec2.CfnSecurityGroupIngress(this, 'myServiceSecurityGroupfromawsecsintegcircuitbreakermyServiceLBSecurityGroupB690840480BBFF8B33', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 80,
    ...
    myServiceSecurityGroupfromawsecsintegcircuitbreakermyServiceLbSecurityGroupB690840480bbff8b33.addDependency(myServiceTaskDefTaskRole1C1de6cc);
