...
export interface test-codebuild-githubProps extends cdk.StackProps {
  /**
...
export class test-codebuild-github extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: test-codebuild-githubProps = {}) {
