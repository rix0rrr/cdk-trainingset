...
export interface TestCodebuildGithubProps extends cdk.StackProps {
  /**
...
export class TestCodebuildGithub extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: TestCodebuildGithubProps = {}) {
