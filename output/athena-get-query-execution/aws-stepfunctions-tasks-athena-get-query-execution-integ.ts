...
export interface AwsStepfunctionsTasksAthenaGetQueryExecutionIntegProps extends cdk.StackProps {
  /**
...
export class AwsStepfunctionsTasksAthenaGetQueryExecutionInteg extends cdk.Stack {
  public readonly stateMachineArn;

  public constructor(scope: cdk.App, id: string, props: AwsStepfunctionsTasksAthenaGetQueryExecutionIntegProps = {}) {
