...
export interface aws-stepfunctions-tasks-athena-get-query-execution-integProps extends cdk.StackProps {
  /**
...
export class aws-stepfunctions-tasks-athena-get-query-execution-integ extends cdk.Stack {
  public readonly stateMachineArn;

  public constructor(scope: cdk.App, id: string, props: aws-stepfunctions-tasks-athena-get-query-execution-integProps = {}) {
