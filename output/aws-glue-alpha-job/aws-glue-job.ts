...
export interface AwsGlueJobProps extends cdk.StackProps {
  /**
...
export class AwsGlueJob extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsGlueJobProps = {}) {
