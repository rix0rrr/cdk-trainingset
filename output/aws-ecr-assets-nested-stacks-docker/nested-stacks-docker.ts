...
export interface NestedStacksDockerProps extends cdk.StackProps {
  /**
...
export class NestedStacksDocker extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: NestedStacksDockerProps = {}) {
