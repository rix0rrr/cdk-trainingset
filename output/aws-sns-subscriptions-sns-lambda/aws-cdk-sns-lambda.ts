...
export interface AwsCdkSnsLambdaProps extends cdk.StackProps {
  /**
...
export class AwsCdkSnsLambda extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkSnsLambdaProps = {}) {
