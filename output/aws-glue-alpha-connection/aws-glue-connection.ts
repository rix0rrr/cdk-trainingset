...
export interface aws-glue-connectionProps extends cdk.StackProps {
  /**
...
export class aws-glue-connection extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-glue-connectionProps = {}) {
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-glue-connection/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-glue-connection/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const securityGroupDd263621 = new ec2.CfnSecurityGroup(this, 'SecurityGroupDD263621', {
      groupDescription: 'aws-glue-connection/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const vpcPrivateSubnet1RouteTableB2c5b500 = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet1RouteTableB2C5B500', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-glue-connection/Vpc/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-glue-connection/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const networkConnection2B07b7e5 = new glue.CfnConnection(this, 'NetworkConnection2B07B7E5', {
