...
export interface AwsGlueConnectionProps extends cdk.StackProps {
  /**
...
export class AwsGlueConnection extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsGlueConnectionProps = {}) {
