  ...
  public constructor(scope: cdk.App, id: string, props: AwsCdkInterfaceVpcEndpointProps = {}) {
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-interface-vpc-endpoint/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-interface-vpc-endpoint/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip4947bc00 = new ec2.CfnEIP(this, 'VPCPublicSubnet2EIP4947BC00', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-interface-vpc-endpoint/VPC/PublicSubnet2',
        },
      ],
    });

    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    const interfaceEndpointSecurityGroup4F1cbad1 = new ec2.CfnSecurityGroup(this, 'InterfaceEndpointSecurityGroup4F1CBAD1', {
      groupDescription: 'aws-cdk-interface-vpc-endpoint/InterfaceEndpoint/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const vpcPrivateSubnet1RouteTableBe8a6027 = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet1RouteTableBE8A6027', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-interface-vpc-endpoint/VPC/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-interface-vpc-endpoint/VPC/PrivateSubnet2',
        },
      ],
    });
    ...
    if (interfaceEndpointSecurityGroup4F1cbad1 == null) { throw new Error(`A combination of conditions caused 'interfaceEndpointSecurityGroup4F1cbad1' to be undefined. Fixit.`); }
    if (vpcb9e5f0b4 == null) { throw new Error(`A combination of conditions caused 'vpcb9e5f0b4' to be undefined. Fixit.`); }
    ...
    const interfaceEndpoint12De6e71 = new ec2.CfnVPCEndpoint(this, 'InterfaceEndpoint12DE6E71', {
      serviceName: 'com.amazonaws.us-west-2.sms',
      vpcId: vpcb9e5f0b4.ref,
      privateDnsEnabled: false,
      securityGroupIds: [
        interfaceEndpointSecurityGroup4F1cbad1.attrGroupId,
      ],
      subnetIds: [
    ...
    if (interfaceEndpoint12De6e71 == null) { throw new Error(`A combination of conditions caused 'interfaceEndpoint12De6e71' to be undefined. Fixit.`); }
    if (privateZone27242E85 == null) { throw new Error(`A combination of conditions caused 'privateZone27242E85' to be undefined. Fixit.`); }
    const aliasEndpointRecord40E9201f = new route53.CfnRecordSet(this, 'AliasEndpointRecord40E9201F', {
      name: 'foo.test.aws.cdk.com.',
      type: 'A',
      aliasTarget: {
        dnsName: cdk.Fn.select(1, cdk.Fn.split(':', cdk.Fn.select(0, interfaceEndpoint12De6e71.attrDnsEntries))),
        hostedZoneId: cdk.Fn.select(0, cdk.Fn.split(':', cdk.Fn.select(0, interfaceEndpoint12De6e71.attrDnsEntries))),
      },
