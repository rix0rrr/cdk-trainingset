...
export class LambdaEventSourceFilterCriteriaDynamodb extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: LambdaEventSourceFilterCriteriaDynamodbProps = {}) {
    ...
    if (td925bc7e == null) { throw new Error(`A combination of conditions caused 'td925bc7e' to be undefined. Fixit.`); }
    const fDynamoDbEventSourcelambdaeventsourcefiltercriteriadynamodbT9cfe7d0657833f11 = new lambda.CfnEventSourceMapping(this, 'FDynamoDBEventSourcelambdaeventsourcefiltercriteriadynamodbT9CFE7D0657833F11', {
      batchSize: 5,
