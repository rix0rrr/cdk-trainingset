...
export interface C9automaticStopStackProps extends cdk.StackProps {
  /**
...
export class C9automaticStopStack extends cdk.Stack {
  public readonly url;
  public readonly arn;

  public constructor(scope: cdk.App, id: string, props: C9automaticStopStackProps = {}) {
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'C9automaticStopStack/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'C9automaticStopStack/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'C9automaticStopStack/VPC/PrivateSubnet2',
        },
      ],
    });
    ...
    const vpcPublicSubnet2RouteTable6F1a15f1 = new ec2.CfnRouteTable(this, 'VPCPublicSubnet2RouteTable6F1A15F1', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'C9automaticStopStack/VPC/PublicSubnet2',
        },
      ],
    });
