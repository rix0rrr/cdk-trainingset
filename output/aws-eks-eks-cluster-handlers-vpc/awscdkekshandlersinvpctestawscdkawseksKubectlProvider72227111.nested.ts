...
export interface awscdkekshandlersinvpctestawscdkawseksKubectlProvider72227111.nestedProps extends cdk.StackProps {
  /**
   */
  readonly referencetoawscdkekshandlersinvpctestKubectlLayerAd42127bRef: string;
  /**
   */
  readonly referencetoawscdkekshandlersinvpctestEksAllHandlersInVpcStackKubectlHandlerRole12Bcdbc7Arn: string;
  /**
   */
  ...
  /**
   */
  readonly referencetoawscdkekshandlersinvpctestEksAllHandlersInVpcStack429D29c0ClusterSecurityGroupId: string;
}

export class awscdkekshandlersinvpctestawscdkawseksKubectlProvider72227111.nested extends cdk.Stack {
  public readonly awscdkekshandlersinvpctestawscdkawseksKubectlProviderframeworkonEventB8d0a5e7Arn;

  public constructor(scope: cdk.App, id: string, props: awscdkekshandlersinvpctestawscdkawseksKubectlProvider72227111.nestedProps) {
    ...
    const handler886Cb40b = new lambda.CfnFunction(this, 'Handler886CB40B', {
      ...
      layers: [
        ...
        props.referencetoawscdkekshandlersinvpctestKubectlLayerAd42127bRef!,
      ],
      memorySize: 1024,
      role: props.referencetoawscdkekshandlersinvpctestEksAllHandlersInVpcStackKubectlHandlerRole12Bcdbc7Arn!,
      runtime: 'python3.10',
      timeout: 900,
      vpcConfig: {
        securityGroupIds: [
          props.referencetoawscdkekshandlersinvpctestEksAllHandlersInVpcStack429D29c0ClusterSecurityGroupId!,
        ],
        subnetIds: [
    ...
    // Outputs
    this.awscdkekshandlersinvpctestawscdkawseksKubectlProviderframeworkonEventB8d0a5e7Arn = providerframeworkonEvent83C1d0a7.attrArn;
    new cdk.CfnOutput(this, 'CfnOutputawscdkekshandlersinvpctestawscdkawseksKubectlProviderframeworkonEventB8D0A5E7Arn', {
      key: 'awscdkekshandlersinvpctestawscdkawseksKubectlProviderframeworkonEventB8D0A5E7Arn',
      value: this.awscdkekshandlersinvpctestawscdkawseksKubectlProviderframeworkonEventB8d0a5e7Arn!.toString(),
    });
  }
}
