...
export interface aws-ecs-integ-secretProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-secret extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-secretProps = {}) {
