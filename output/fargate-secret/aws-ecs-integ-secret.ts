...
export interface AwsEcsIntegSecretProps extends cdk.StackProps {
  /**
...
export class AwsEcsIntegSecret extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegSecretProps = {}) {
