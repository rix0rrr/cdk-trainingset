...
export interface EdgeLambdaStackEuWest12Props extends cdk.StackProps {
  /**
...
export class EdgeLambdaStackEuWest12 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: EdgeLambdaStackEuWest12Props = {}) {
