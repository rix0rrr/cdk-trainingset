...
export interface aws-gamelift-aliasProps extends cdk.StackProps {
  /**
...
export class aws-gamelift-alias extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-gamelift-aliasProps = {}) {
