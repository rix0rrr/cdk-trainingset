...
export interface AwsAppconfigEnvironmentProps extends cdk.StackProps {
  /**
...
export class AwsAppconfigEnvironment extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsAppconfigEnvironmentProps = {}) {
