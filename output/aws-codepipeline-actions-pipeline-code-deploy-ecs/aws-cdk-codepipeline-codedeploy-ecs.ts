...
export interface aws-cdk-codepipeline-codedeploy-ecsProps extends cdk.StackProps {
  /**
...
export class aws-cdk-codepipeline-codedeploy-ecs extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-codepipeline-codedeploy-ecsProps = {}) {
