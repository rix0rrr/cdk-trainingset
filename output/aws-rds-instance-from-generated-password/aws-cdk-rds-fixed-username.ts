...
export interface aws-cdk-rds-fixed-usernameProps extends cdk.StackProps {
  /**
...
export class aws-cdk-rds-fixed-username extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-rds-fixed-usernameProps = {}) {
    ...
    const awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de = new secretsmanager.CfnSecret(this, 'awscdkrdsfixedusernameInstanceSecretADA7FA0A0ae21a5e1432db367b627106107972de', {
      description: [
    ...
    awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.DELETE;
    ...
    if (awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de == null) { throw new Error(`A combination of conditions caused 'awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de' to be undefined. Fixit.`); }
    const instanceC1063a87 = new rds.CfnDBInstance(this, 'InstanceC1063A87', {
      ...
      masterUserPassword: [
        ...
        awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de.ref,
    ...
    instanceC1063a87.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.SNAPSHOT;
    ...
    const instanceSecretAttachment83Bee581 = new secretsmanager.CfnSecretTargetAttachment(this, 'InstanceSecretAttachment83BEE581', {
      secretId: awscdkrdsfixedusernameInstanceSecretAda7fa0a0ae21a5e1432db367b627106107972de.ref,
