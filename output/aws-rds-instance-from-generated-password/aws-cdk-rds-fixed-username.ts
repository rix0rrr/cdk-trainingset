...
export interface AwsCdkRdsFixedUsernameProps extends cdk.StackProps {
  /**
...
export class AwsCdkRdsFixedUsername extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkRdsFixedUsernameProps = {}) {
