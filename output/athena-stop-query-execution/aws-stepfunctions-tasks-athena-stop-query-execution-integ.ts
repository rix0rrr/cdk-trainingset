...
export interface AwsStepfunctionsTasksAthenaStopQueryExecutionIntegProps extends cdk.StackProps {
  /**
...
export class AwsStepfunctionsTasksAthenaStopQueryExecutionInteg extends cdk.Stack {
  public readonly stateMachineArn;

  public constructor(scope: cdk.App, id: string, props: AwsStepfunctionsTasksAthenaStopQueryExecutionIntegProps = {}) {
