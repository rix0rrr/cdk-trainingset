...
export interface AwsGameliftScriptProps extends cdk.StackProps {
  /**
...
export class AwsGameliftScript extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsGameliftScriptProps = {}) {
