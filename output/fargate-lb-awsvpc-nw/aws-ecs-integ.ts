...
export class aws-ecs-integ extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: aws-ecs-integProps = {}) {
    ...
    const lbPublicListenerFargateGroup5Ee2fbaf = new elasticloadbalancingv2.CfnTargetGroup(this, 'LBPublicListenerFargateGroup5EE2FBAF', {
      port: 80,
      protocol: 'HTTP',
    ...
    serviceSecurityGroupC96ed6a7.addDependency(taskDefTaskRole1Edb4a67);
    ...
    const lbSecurityGrouptoawsecsintegServiceSecurityGroup48Ee4368807b287d7f = new ec2.CfnSecurityGroupEgress(this, 'LBSecurityGrouptoawsecsintegServiceSecurityGroup48EE4368807B287D7F', {
      groupId: lbSecurityGroup8A41ea2b.attrGroupId,
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      destinationSecurityGroupId: serviceSecurityGroupC96ed6a7.attrGroupId,
      fromPort: 80,
      toPort: 80,
    });
    ...
    if (serviceSecurityGroupC96ed6a7 == null) { throw new Error(`A combination of conditions caused 'serviceSecurityGroupC96ed6a7' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    const serviceSecurityGroupfromawsecsintegLbSecurityGroupC30f5eb480cd1b9463 = new ec2.CfnSecurityGroupIngress(this, 'ServiceSecurityGroupfromawsecsintegLBSecurityGroupC30F5EB480CD1B9463', {
      ipProtocol: 'tcp',
      description: 'Load balancer to target',
      fromPort: 80,
      groupId: serviceSecurityGroupC96ed6a7.attrGroupId,
      sourceSecurityGroupId: lbSecurityGroup8A41ea2b.attrGroupId,
      toPort: 80,
    });
    serviceSecurityGroupfromawsecsintegLbSecurityGroupC30f5eb480cd1b9463.addDependency(taskDefTaskRole1Edb4a67);
    ...
    lb8a12904c.addDependency(vpcPublicSubnet1DefaultRoute3Da9e72a);
    lb8a12904c.addDependency(vpcPublicSubnet1RouteTableAssociation97140677);
    lb8a12904c.addDependency(vpcPublicSubnet2DefaultRoute97F91067);
    lb8a12904c.addDependency(vpcPublicSubnet2RouteTableAssociationDd5762d8);
    ...
    if (lbPublicListenerFargateGroup5Ee2fbaf == null) { throw new Error(`A combination of conditions caused 'lbPublicListenerFargateGroup5Ee2fbaf' to be undefined. Fixit.`); }
    const lbPublicListener6E1f3d94 = new elasticloadbalancingv2.CfnListener(this, 'LBPublicListener6E1F3D94', {
      defaultActions: [
        {
          targetGroupArn: lbPublicListenerFargateGroup5Ee2fbaf.ref,
          type: 'forward',
        },
      ],
    ...
    if (lbPublicListener6E1f3d94 == null) { throw new Error(`A combination of conditions caused 'lbPublicListener6E1f3d94' to be undefined. Fixit.`); }
    if (lbPublicListenerFargateGroup5Ee2fbaf == null) { throw new Error(`A combination of conditions caused 'lbPublicListenerFargateGroup5Ee2fbaf' to be undefined. Fixit.`); }
    if (serviceSecurityGroupC96ed6a7 == null) { throw new Error(`A combination of conditions caused 'serviceSecurityGroupC96ed6a7' to be undefined. Fixit.`); }
    ...
    serviceD69d759b.addDependency(lbPublicListenerFargateGroup5Ee2fbaf);
    serviceD69d759b.addDependency(lbPublicListener6E1f3d94);
    serviceD69d759b.addDependency(taskDefTaskRole1Edb4a67);

    if (fargateCluster7Ccd5f93 == null) { throw new Error(`A combination of conditions caused 'fargateCluster7Ccd5f93' to be undefined. Fixit.`); }
    if (serviceD69d759b == null) { throw new Error(`A combination of conditions caused 'serviceD69d759b' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    const serviceTaskCountTarget23E25614 = new applicationautoscaling.CfnScalableTarget(this, 'ServiceTaskCountTarget23E25614', {
      maxCapacity: 10,
      minCapacity: 1,
      resourceId: [
        'service/',
    ...
    serviceTaskCountTarget23E25614.addDependency(taskDefTaskRole1Edb4a67);

    if (serviceTaskCountTarget23E25614 == null) { throw new Error(`A combination of conditions caused 'serviceTaskCountTarget23E25614' to be undefined. Fixit.`); }
    if (taskDefTaskRole1Edb4a67 == null) { throw new Error(`A combination of conditions caused 'taskDefTaskRole1Edb4a67' to be undefined. Fixit.`); }
    const serviceTaskCountTargetReasonableCpu4174Efce = new applicationautoscaling.CfnScalingPolicy(this, 'ServiceTaskCountTargetReasonableCpu4174EFCE', {
      policyName: 'awsecsintegServiceTaskCountTargetReasonableCpuDB6AEA73',
      policyType: 'TargetTrackingScaling',
      scalingTargetId: serviceTaskCountTarget23E25614.ref,
    ...
    serviceTaskCountTargetReasonableCpu4174Efce.addDependency(taskDefTaskRole1Edb4a67);

    // Outputs
    this.loadBalancerDns = lb8a12904c.attrDnsName;
