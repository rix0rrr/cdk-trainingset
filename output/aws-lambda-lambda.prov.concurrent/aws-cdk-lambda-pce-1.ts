...
export interface AwsCdkLambdaPce1Props extends cdk.StackProps {
  /**
...
export class AwsCdkLambdaPce1 extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkLambdaPce1Props = {}) {
