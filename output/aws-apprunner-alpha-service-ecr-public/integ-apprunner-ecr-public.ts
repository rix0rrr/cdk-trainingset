...
export interface IntegApprunnerEcrPublicProps extends cdk.StackProps {
  /**
...
export class IntegApprunnerEcrPublic extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: IntegApprunnerEcrPublicProps = {}) {
