  ...
  public constructor(scope: cdk.App, id: string, props: AwsCdkRdsInstanceS3IntegProps = {}) {
    ...
    const vpcb9e5f0b4 = new ec2.CfnVPC(this, 'VPCB9E5F0B4', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-instance-s3-integ/VPC',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eip6ad938e8 = new ec2.CfnEIP(this, 'VPCPublicSubnet1EIP6AD938E8', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-instance-s3-integ/VPC/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip4947bc00 = new ec2.CfnEIP(this, 'VPCPublicSubnet2EIP4947BC00', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-instance-s3-integ/VPC/PublicSubnet2',
        },
      ],
    });
    ...
    const databaseInstanceOptionGroupDa39e317 = new rds.CfnOptionGroup(this, 'DatabaseInstanceOptionGroupDA39E317', {
      engineName: 'sqlserver-se',
      majorEngineVersion: '14.00',
      optionGroupDescription: 'Option group for sqlserver-se 14.00',
      optionConfigurations: [
        {
          ...
          optionSettings: [
            {
              name: 'IAM_ROLE_ARN',
              value: databaseS3ImportRole377Bc9c0.attrArn,
            },
          ],
        },
      ],
    ...
    const vpcPrivateSubnet1RouteTableBe8a6027 = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet1RouteTableBE8A6027', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-instance-s3-integ/VPC/PrivateSubnet1',
        },
      ],
    });
    ...
    const vpcPrivateSubnet2RouteTable0A19e10e = new ec2.CfnRouteTable(this, 'VPCPrivateSubnet2RouteTable0A19E10E', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-cdk-rds-instance-s3-integ/VPC/PrivateSubnet2',
        },
      ],
    });
    ...
    const databaseSubnetGroup7D60f180 = new rds.CfnDBSubnetGroup(this, 'DatabaseSubnetGroup7D60F180', {
    ...
    if (databaseInstanceOptionGroupDa39e317 == null) { throw new Error(`A combination of conditions caused 'databaseInstanceOptionGroupDa39e317' to be undefined. Fixit.`); }
    if (databaseS3ImportRole377Bc9c0 == null) { throw new Error(`A combination of conditions caused 'databaseS3ImportRole377Bc9c0' to be undefined. Fixit.`); }
    ...
    if (databaseSubnetGroup7D60f180 == null) { throw new Error(`A combination of conditions caused 'databaseSubnetGroup7D60f180' to be undefined. Fixit.`); }
    const databaseB269d8bb = new rds.CfnDBInstance(this, 'DatabaseB269D8BB', {
      ...
      dbSubnetGroupName: databaseSubnetGroup7D60f180.ref,
      engine: 'sqlserver-se',
      engineVersion: '14.00',
      ...
      optionGroupName: databaseInstanceOptionGroupDa39e317.ref,
      storageType: 'gp2',
      vpcSecurityGroups: [
