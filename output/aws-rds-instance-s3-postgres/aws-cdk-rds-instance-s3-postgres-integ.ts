...
export interface aws-cdk-rds-instance-s3-postgres-integProps extends cdk.StackProps {
  /**
...
export class aws-cdk-rds-instance-s3-postgres-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-rds-instance-s3-postgres-integProps = {}) {
