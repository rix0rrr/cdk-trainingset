...
export class AwsEcsInteg extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegProps = {}) {
    ...
    const ecsClusterDefaultAutoScalingGroupInstanceSecurityGroupfromawsecsintegLbSecurityGroupC30f5eb480a6611bd8 = new ec2.CfnSecurityGroupIngress(this, 'EcsClusterDefaultAutoScalingGroupInstanceSecurityGroupfromawsecsintegLBSecurityGroupC30F5EB480A6611BD8', {
      ipProtocol: 'tcp',
    ...
    if (ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231 == null) { throw new Error(`A combination of conditions caused 'ecsClusterDefaultAutoScalingGroupInstanceSecurityGroup912E1231' to be undefined. Fixit.`); }
    if (lbSecurityGroup8A41ea2b == null) { throw new Error(`A combination of conditions caused 'lbSecurityGroup8A41ea2b' to be undefined. Fixit.`); }
    const lbSecurityGrouptoawsecsintegEcsClusterDefaultAutoScalingGroupInstanceSecurityGroupF03d24578019ab9ba2 = new ec2.CfnSecurityGroupEgress(this, 'LBSecurityGrouptoawsecsintegEcsClusterDefaultAutoScalingGroupInstanceSecurityGroupF03D24578019AB9BA2', {
      ...
      loadBalancers: [
        {
          containerName: 'web',
          containerPort: 80,
          loadBalancerName: lb8a12904c.ref,
        },
      ],
