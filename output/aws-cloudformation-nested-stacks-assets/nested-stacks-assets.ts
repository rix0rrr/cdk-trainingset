...
export interface NestedStacksAssetsProps extends cdk.StackProps {
  /**
...
export class NestedStacksAssets extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: NestedStacksAssetsProps = {}) {
