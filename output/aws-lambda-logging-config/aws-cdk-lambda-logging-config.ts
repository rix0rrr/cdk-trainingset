...
export interface aws-cdk-lambda-logging-configProps extends cdk.StackProps {
  /**
...
export class aws-cdk-lambda-logging-config extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-lambda-logging-configProps = {}) {
