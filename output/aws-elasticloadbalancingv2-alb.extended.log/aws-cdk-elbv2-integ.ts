...
export class AwsCdkElbv2Integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkElbv2IntegProps = {}) {
    ...
    // Resources
    const lbalbAccessLogsBucket6Ae92937 = new s3.CfnBucket(this, 'LBALBAccessLogsBucket6AE92937', {
      bucketEncryption: {
    ...
    lbalbAccessLogsBucket6Ae92937.cfnOptions.deletionPolicy = cdk.CfnDeletionPolicy.RETAIN;
    ...
    if (lbalbAccessLogsBucket6Ae92937 == null) { throw new Error(`A combination of conditions caused 'lbalbAccessLogsBucket6Ae92937' to be undefined. Fixit.`); }
    const lbalbAccessLogsBucketPolicy1E4ebafe = new s3.CfnBucketPolicy(this, 'LBALBAccessLogsBucketPolicy1E4EBAFE', {
      bucket: lbalbAccessLogsBucket6Ae92937.ref,
      policyDocument: {
        Statement: [
          {
            Action: 's3:*',
            ...
            Resource: [
              lbalbAccessLogsBucket6Ae92937.attrArn,
              [
                lbalbAccessLogsBucket6Ae92937.attrArn,
                '/*',
              ].join(''),
          ...
          },
          {
            ...
            Condition: {
              ArnLike: {
                'aws:SourceArn': lbalbAccessLogsBucket6Ae92937.attrArn,
              },
              StringEquals: {
          ...
          },
          {
            ...
            Resource: lbalbAccessLogsBucket6Ae92937.attrArn,
          },
        ],
        Version: '2012-10-17',
      },
    ...
    const lb8a12904c = new elasticloadbalancingv2.CfnLoadBalancer(this, 'LB8A12904C', {
      loadBalancerAttributes: [
        ...
        },
        {
          ...
          value: lbalbAccessLogsBucket6Ae92937.ref,
        },
        {
    ...
    lb8a12904c.addDependency(lbalbAccessLogsBucket6Ae92937);
