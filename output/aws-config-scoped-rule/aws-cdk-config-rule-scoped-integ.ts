...
export interface AwsCdkConfigRuleScopedIntegProps extends cdk.StackProps {
  /**
...
export class AwsCdkConfigRuleScopedInteg extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkConfigRuleScopedIntegProps = {}) {
