...
export interface AwsEcsIntegL3AutocreateProps extends cdk.StackProps {
  /**
...
export class AwsEcsIntegL3Autocreate extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: AwsEcsIntegL3AutocreateProps = {}) {
