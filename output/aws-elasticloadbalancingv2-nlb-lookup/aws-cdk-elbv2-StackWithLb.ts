...
export class AwsCdkElbv2Stackwithlb extends cdk.Stack {
  ...
  public constructor(scope: cdk.App, id: string, props: AwsCdkElbv2StackwithlbProps = {}) {
    ...
    const lbListenerTargetGroupGroup07C223bf = new elasticloadbalancingv2.CfnTargetGroup(this, 'LBListenerTargetGroupGroup07C223BF', {
      port: 443,
      protocol: 'TCP',
      targets: [
        {
    ...
    if (lbListenerTargetGroupGroup07C223bf == null) { throw new Error(`A combination of conditions caused 'lbListenerTargetGroupGroup07C223bf' to be undefined. Fixit.`); }
    const lbListener49E825b4 = new elasticloadbalancingv2.CfnListener(this, 'LBListener49E825B4', {
      defaultActions: [
        {
          targetGroupArn: lbListenerTargetGroupGroup07C223bf.ref,
          type: 'forward',
        },
      ],
    ...
    // Outputs
    this.nlbArn = lb8a12904c.ref;
    new cdk.CfnOutput(this, 'CfnOutputNlbArn', {
      key: 'NlbArn',
      exportName: 'NlbArn',
      value: this.nlbArn!.toString(),
    });
    this.tgArn = lbListenerTargetGroupGroup07C223bf.ref;
    new cdk.CfnOutput(this, 'CfnOutputTgArn', {
      key: 'TgArn',
      exportName: 'TgArn',
      value: this.tgArn!.toString(),
    });
    this.exportsOutputRefLb8a12904c1150d6a6 = lb8a12904c.ref;
    new cdk.CfnOutput(this, 'CfnOutputExportsOutputRefLB8A12904C1150D6A6', {
      key: 'ExportsOutputRefLB8A12904C1150D6A6',
      exportName: 'aws-cdk-elbv2-StackWithLb:ExportsOutputRefLB8A12904C1150D6A6',
      value: this.exportsOutputRefLb8a12904c1150d6a6!.toString(),
    });
    this.exportsOutputRefLbListenerTargetGroupGroup07C223bf73476d0d = lbListenerTargetGroupGroup07C223bf.ref;
    new cdk.CfnOutput(this, 'CfnOutputExportsOutputRefLBListenerTargetGroupGroup07C223BF73476D0D', {
      key: 'ExportsOutputRefLBListenerTargetGroupGroup07C223BF73476D0D',
      exportName: 'aws-cdk-elbv2-StackWithLb:ExportsOutputRefLBListenerTargetGroupGroup07C223BF73476D0D',
      value: this.exportsOutputRefLbListenerTargetGroupGroup07C223bf73476d0d!.toString(),
    });
  }
}
