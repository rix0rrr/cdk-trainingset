...
export interface aws-cdk-codepipeline-codedeployProps extends cdk.StackProps {
  /**
...
export class aws-cdk-codepipeline-codedeploy extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-codepipeline-codedeployProps = {}) {
