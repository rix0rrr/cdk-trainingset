...
export interface LambdaEventSourceSnsProps extends cdk.StackProps {
  /**
...
export class LambdaEventSourceSns extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: LambdaEventSourceSnsProps = {}) {
