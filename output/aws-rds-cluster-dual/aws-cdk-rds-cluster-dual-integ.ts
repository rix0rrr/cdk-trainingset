...
export interface aws-cdk-rds-cluster-dual-integProps extends cdk.StackProps {
  /**
...
export class aws-cdk-rds-cluster-dual-integ extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: aws-cdk-rds-cluster-dual-integProps = {}) {
