...
export interface AwsCdkCodepipelineCloudformationCrossRegionProps extends cdk.StackProps {
  /**
...
export class AwsCdkCodepipelineCloudformationCrossRegion extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsCdkCodepipelineCloudformationCrossRegionProps = {}) {
