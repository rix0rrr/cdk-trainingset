...
export interface aws-ecs-integ-albProps extends cdk.StackProps {
  /**
...
export class aws-ecs-integ-alb extends cdk.Stack {
  public readonly myServiceLoadBalancerDns3a083e9f;
  public readonly myServiceServiceUrl1258c56b;

  public constructor(scope: cdk.App, id: string, props: aws-ecs-integ-albProps = {}) {
    ...
    const firstAutoScalingGroupInstanceRoleC3260ebe = new iam.CfnRole(this, 'FirstAutoScalingGroupInstanceRoleC3260EBE', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb/FirstAutoScalingGroup',
        },
      ],
    });
    ...
    const secondAutoScalingGroupInstanceRoleB7de61a1 = new iam.CfnRole(this, 'SecondAutoScalingGroupInstanceRoleB7DE61A1', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb/SecondAutoScalingGroup',
        },
      ],
    });
    ...
    const vpcPublicSubnet1Eipd7e02669 = new ec2.CfnEIP(this, 'VpcPublicSubnet1EIPD7E02669', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb/Vpc/PublicSubnet1',
        },
      ],
    });
    ...
    const vpcPublicSubnet2Eip3c605a87 = new ec2.CfnEIP(this, 'VpcPublicSubnet2EIP3C605A87', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb/Vpc/PublicSubnet2',
        },
      ],
    });
    ...
    const securityGroupDd263621 = new ec2.CfnSecurityGroup(this, 'SecurityGroupDD263621', {
      groupDescription: 'aws-ecs-integ-alb/SecurityGroup',
      securityGroupEgress: [
        {
          cidrIp: '0.0.0.0/0',
    ...
    const vpcPrivateSubnet2RouteTableA678073b = new ec2.CfnRouteTable(this, 'VpcPrivateSubnet2RouteTableA678073B', {
      ...
      tags: [
        {
          key: 'Name',
          value: 'aws-ecs-integ-alb/Vpc/PrivateSubnet2',
        },
      ],
    });
    ...
    const myServiceLbSecurityGroupFe0ed608 = new ec2.CfnSecurityGroup(this, 'myServiceLBSecurityGroupFE0ED608', {
      groupDescription: 'Automatically created Security Group for ELB awsecsintegalbmyServiceLBBBB2F01E',
      securityGroupEgress: [
        {
        ...
        tagSpecifications: [
          {
            ...
            tags: [
              {
                key: 'Name',
                value: 'aws-ecs-integ-alb/FirstAutoScalingGroup/LaunchTemplate',
              },
            ],
          },
          {
        ...
        tagSpecifications: [
          {
            ...
            tags: [
              {
                key: 'Name',
                value: 'aws-ecs-integ-alb/SecondAutoScalingGroup/LaunchTemplate',
              },
            ],
          },
          {
    ...
    const firstCapacityProvierD92f5ac4 = new ecs.CfnCapacityProvider(this, 'FirstCapacityProvierD92F5AC4', {
    ...
    const secondCapacityProvierAde5da56 = new ecs.CfnCapacityProvider(this, 'SecondCapacityProvierADE5DA56', {
      autoScalingGroupProvider: {
    ...
    if (clusterEb0386a7 == null) { throw new Error(`A combination of conditions caused 'clusterEb0386a7' to be undefined. Fixit.`); }
    if (firstCapacityProvierD92f5ac4 == null) { throw new Error(`A combination of conditions caused 'firstCapacityProvierD92f5ac4' to be undefined. Fixit.`); }
    if (secondCapacityProvierAde5da56 == null) { throw new Error(`A combination of conditions caused 'secondCapacityProvierAde5da56' to be undefined. Fixit.`); }
    const cluster3Da9ccba = new ecs.CfnClusterCapacityProviderAssociations(this, 'Cluster3DA9CCBA', {
      capacityProviders: [
        firstCapacityProvierD92f5ac4.ref,
        secondCapacityProvierAde5da56.ref,
      ],
    ...
    const myServiceB0b6faa0 = new ecs.CfnService(this, 'myServiceB0B6FAA0', {
      capacityProviderStrategy: [
        {
          base: 1,
          capacityProvider: firstCapacityProvierD92f5ac4.ref,
          weight: 1,
        },
        {
          base: 0,
          capacityProvider: secondCapacityProvierAde5da56.ref,
          weight: 2,
        },
      ],
      cluster: clusterEb0386a7.ref,
