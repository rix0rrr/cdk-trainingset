...
export interface AwsGameliftBuildFleetProps extends cdk.StackProps {
  /**
...
export class AwsGameliftBuildFleet extends cdk.Stack {
  public constructor(scope: cdk.App, id: string, props: AwsGameliftBuildFleetProps = {}) {
